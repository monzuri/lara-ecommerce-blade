...
<body>
    ...
    <div class="topbar">
        <div class="container-topbar">
            <div class="menu-topbar-left d-none d-xl-block">
                <ul class="nav-small">
                    <li><a class="font-xs" href="{{ url('page-about-us') }}">About Us</a></li>
                    <li><a class="font-xs" href="{{ url('page-careers') }}">Careers</a></li>
                    <li><a class="font-xs" href="{{ url('page-register') }}">Open a shop</a></li>
                </ul>
            </div>
        ...
        <div class="container">
            <div class="main-header">
                <div class="header-left">
                    <div class="header-logo"><a class="d-flex" href="{{ url('') }}"><img alt="Ecom"
                            ...
                            <ul class="main-menu">
                                <li class="has-children"><a class="active" href="{{ url('') }}">Home</a>
                                    <ul class="sub-menu two-col">
                                        ...
                                        <li><a href="{{ url('index-2') }}">Homepage - 2</a></li>
                                        <li><a href="{{ url('index-3') }}">Homepage - 3</a></li>
                                        <li><a href="{{ url('index-4') }}">Homepage - 4</a></li>
                                        <li><a href="{{ url('index-5') }}">Homepage - 5</a></li>
                                        <li><a href="{{ url('index-6') }}">Homepage - 6</a></li>
                                        <li><a href="{{ url('index-7') }}">Homepage - 7</a></li>
                                        <li><a href="{{ url('index-8') }}">Homepage - 8</a></li>
                                        <li><a href="{{ url('index-9') }}">Homepage - 9</a></li>
                                        <li><a href="{{ url('index-10') }}">Homepage - 10</a></li>
                                    </ul>
                                </li>
                                <li class="has-children"><a href="{{ url('shop-grid') }}">Shop</a>
                                    <ul class="sub-menu two-col">
                                        <li><a href="{{ url('shop-grid') }}">Shop Grid</a></li>
                                        <li><a href="{{ url('shop-grid-2') }}">Shop Grid 2</a></li>
                                        <li><a href="{{ url('shop-list') }}">Shop list - Left sidebar</a></li>
                                        <li><a href="{{ url('shop-list-2') }}">Shop list - Right sidebar</a></li>
                                        <li><a href="{{ url('shop-fullwidth') }}">Shop Fullwidth</a></li>
                                        <li><a href="{{ url('shop-single-product') }}">Single Product</a></li>
                                        <li><a href="{{ url('shop-single-product-2') }}">Single Product 2</a>
                                        </li>
                                        <li><a href="{{ url('shop-single-product-3') }}">Single Product 3</a>
                                        </li>
                                        <li><a href="{{ url('shop-single-product-4') }}">Single Product 4</a>
                                        </li>
                                        <li><a href="{{ url('shop-cart') }}">Shop Cart</a></li>
                                        <li><a href="{{ url('shop-checkout') }}">Shop Checkout</a></li>
                                        <li><a href="{{ url('shop-compare') }}">Shop Compare</a></li>
                                        <li><a href="{{ url('shop-wishlist') }}">Shop Wishlist</a></li>
                                    </ul>
                                </li>
                                <li class="has-children"><a href="{{ url('shop-vendor-list') }}">Vendors</a>
                                    <ul class="sub-menu">
                                        <li><a href="{{ url('shop-vendor-list') }}">Vendors Listing</a></li>
                                        <li><a href="{{ url('shop-vendor-single') }}">Vendor Single</a></li>
                                    </ul>
                                </li>
                                <li class="has-children"><a href="{{ url('#') }}">Pages</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="{{ url('page-term') }}">Term and Condition</a></li>
                                        <li><a href="{{ url('page-register') }}">Register</a></li>
                                        <li><a href="{{ url('page-login') }}">Login</a></li>
                                        <li><a href="{{ url('page-404') }}">Error 404</a></li>
                                    </ul>
                                </li>
                                <li class="has-children"><a href="{{ url('blog') }}">Blog</a>
                                    <ul class="sub-menu">
                                        <li><a href="{{ url('blog') }}">Blog - No Sidebar</a></li>
                                        <li><a href="{{ url('blog-2') }}">Blog - Right Sidebar</a></li>
                                        <li><a href="{{ url('blog-list') }}">Blog List</a></li>
                                        <li><a href="{{ url('blog-big') }}">Blog category big</a></li>
                                        <li><a href="{{ url('blog-single') }}">Blog Single - Left sidebar</a>
                                        </li>
                                        <li><a href="{{ url('blog-single-2') }}">Blog Single - Right sidebar</a>
                                        </li>
                                        <li><a href="{{ url('blog-single-3') }}">Blog Single - No sidebar</a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="{{ url('page-contact') }}">Contact Us</a></li>
                        ...
                        <div class="d-inline-block box-dropdown-cart"><span
                            ...
                            <div class="dropdown-account">
                                <ul>
                                    ...
                                    <li><a href="{{ url('page-account') }}">Order Tracking</a></li>
                                    <li><a href="{{ url('page-account') }}">My Orders</a></li>
                                    <li><a href="{{ url('page-account') }}">My Wishlist</a></li>
                                    <li><a href="{{ url('page-account') }}">Setting</a></li>
                                    <li><a href="{{ url('page-login') }}">Sign out</a></li>
                                </ul>
                            </div>
                        </div><a class="font-lg icon-list icon-wishlist"
                            href="{{ url('shop-wishlist') }}"><span>Wishlist</span><span
                            ...
                            <div class="dropdown-cart">
                                <div class="item-cart mb-20">
                                    ...
                                    <div class="cart-info"><a class="font-sm-bold color-brand-3"
                                            href="{{ url('shop-single-product') }}">2022 Apple iMac with Retina
                                            5K Display 8GB
                                            RAM, 256GB SSD</a>
                                ...
                                <div class="item-cart mb-20">
                                    <div class="cart-image"><img
                                            ...
                                            alt="Ecom"></div>
                                    <div class="cart-info"><a class="font-sm-bold color-brand-3"
                                            href="{{ url('shop-single-product-2') }}">2022 Apple iMac with Retina
                                            5K Display
                                            8GB RAM, 256GB SSD</a>
                                        <p><span class="color-brand-2 font-sm-bold">1 x $2856.4</span></p>
                                    </div>
                                ...
                                <div class="cart-total">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-6 text-start"><a class="btn btn-cart w-auto"
                                                href="{{ url('shop-cart') }}">View cart</a></div>
                                        <div class="col-6"><a class="btn btn-buy w-auto"
                                                href="{{ url('shop-checkout') }}">Checkout</a></div>
                                    </div>
                                </div>
                            </div>
                        </div><a class="font-lg icon-list icon-compare"
                            href="{{ url('shop-compare') }}"><span>Compare</span></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mobile-header-active mobile-header-wrapper-style perfect-scrollbar">
        <div class="mobile-header-wrapper-inner">
            <div class="mobile-header-content-area">
                <div class="mobile-logo"><a class="d-flex" href="{{ url('') }}"><img alt="Ecom"
                            src="{{ asset('/assets/imgs/template/logo.svg') }}"></a></div>
                <div class="perfect-scroll">
                            ...
                            <ul class="mobile-menu font-heading">
                                ...
                                <li class="has-children"><a href="{{ url('shop-grid') }}">Shop</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="{{ url('shop-list-2') }}">Shop List 2</a></li>
                                        <li><a href="{{ url('shop-fullwidth') }}">Shop Fullwidth</a></li>
                                        <li><a href="{{ url('shop-single-product') }}">Single Product</a></li>
                                        <li><a href="{{ url('shop-single-product-2') }}">Single Product 2</a>
                                        </li>
                                ...
                                <li class="has-children"><a href="{{ url('blog') }}">Blog</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="{{ url('blog-2') }}">Blog Grid 2</a></li>
                                        <li><a href="{{ url('blog-list') }}">Blog List</a></li>
                                        <li><a href="{{ url('blog-big') }}">Blog Big</a></li>
                                        <li><a href="{{ url('blog-single') }}">Blog Single - Left sidebar</a>
                                        </li>
                                        <li><a href="{{ url('blog-single-2') }}">Blog Single - Right sidebar</a>
                                        </li>
                    ...
                    <div class="mobile-account">
                        <div class="mobile-header-top">
                            <div class="user-account"><a href="{{ url('page-account') }}"><img
    ...
    <div class="sidebar-left"><a class="btn btn-open" href="{{ url('#') }}"></a>
        <ul class="menu-icons hidden">
            <li><a href="{{ url('javascript:void(0)') }}"><img
                        src="{{ asset('/assets/imgs/template/monitor.svg') }}" alt="Ecom"></a></li>
            <li><a href="{{ url('javascript:void(0)') }}"><img
                        src="{{ asset('/assets/imgs/template/mobile.svg') }}" alt="Ecom"></a></li>
        ...
        <ul class="menu-texts menu-close">
            <li class="has-children"><a href="{{ url('shop-grid-2') }}"><span class="img-link"><img
                            src="{{ asset('/assets/imgs/template/monitor.svg') }}" alt="Ecom"></span><span
                        class="text-link">Computers &amp; Accessories</span></a>
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">Computer Accessories</a></li>
                    <li><a href="{{ url('shop-grid') }}">Computer Cases</a></li>
                    <li><a href="{{ url('shop-grid') }}">Laptop</a></li>
                    <li><a href="{{ url('shop-grid') }}">HDD</a></li>
                    <li><a href="{{ url('shop-grid') }}">RAM</a></li>
                    <li><a href="{{ url('shop-grid') }}">Headphone</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('#') }}"><span class="img-link"><img
                        ...
                        Phones</span></a>
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">Phone Accessories</a></li>
                    <li><a href="{{ url('shop-grid') }}">Phone Cases</a></li>
                    <li><a href="{{ url('shop-grid') }}">Postpaid Phones</a></li>
                    <li><a href="{{ url('shop-grid') }}">Unlocked Phones</a></li>
                    <li><a href="{{ url('shop-grid') }}">Prepaid Phones</a></li>
                    <li><a href="{{ url('shop-grid') }}">Prepaid Plans</a></li>
                    <li><a href="{{ url('shop-grid') }}">Refurbished Phones</a></li>
                    <li><a href="{{ url('shop-grid') }}">Straight Talk</a></li>
                    <li><a href="{{ url('shop-grid') }}">iPhone</a></li>
                    <li><a href="{{ url('shop-grid') }}">Samsung Galaxy</a></li>
                    <li><a href="{{ url('shop-grid') }}">Samsung Galaxy</a></li>
                    <li><a href="{{ url('shop-grid') }}">Samsung Galaxy</a></li>
                    <li><a href="{{ url('shop-grid') }}">Samsung Galaxy</a></li>
                    <li><a href="{{ url('shop-grid') }}">Samsung Galaxy</a></li>
            ...
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                            src="{{ asset('/assets/imgs/template/game.svg') }}" alt="Ecom"></span><span
                        class="text-link">Gaming
                        Gatgets</span></a>
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">Wireless Routers</a></li>
                    <li><a href="{{ url('shop-grid') }}">Cool New Gadgets</a></li>
                    <li><a href="{{ url('shop-grid') }}">Tech and Gadgets</a></li>
                    <li><a href="{{ url('shop-grid') }}">Geek Gifts and Gadgets</a></li>
                    <li><a href="{{ url('shop-grid') }}">Xbox Accessories</a></li>
                    <li><a href="{{ url('shop-grid') }}">PlayStation Accessories</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                        ...
                        watches</span></a>
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">Smart Watches</a></li>
                    <li><a href="{{ url('shop-grid') }}">Fashion Smart Watches</a></li>
                    <li><a href="{{ url('shop-grid') }}">Smart Bracelets</a></li>
                    <li><a href="{{ url('shop-grid') }}">Pocket Watches</a></li>
                    <li><a href="{{ url('shop-grid') }}">Smart Rings</a></li>
                    <li><a href="{{ url('shop-grid') }}">Other Watches</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                ...
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">On-Ear Headphones</a></li>
                    <li><a href="{{ url('shop-grid') }}">Earbud & In-Ear</a></li>
                    <li><a href="{{ url('shop-grid') }}">DJ Headphones</a></li>
                    <li><a href="{{ url('shop-grid') }}">PC Accessories</a></li>
                    <li><a href="{{ url('shop-grid') }}">PC Game Headsets</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                        ...
                        &amp; Keyboard</span></a>
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">Logitech</a></li>
                    <li><a href="{{ url('shop-grid') }}">Redragon</a></li>
                    <li><a href="{{ url('shop-grid') }}">Amazon Basics</a></li>
                    <li><a href="{{ url('shop-grid') }}">Microsoft</a></li>
                    <li><a href="{{ url('shop-grid') }}">MageGee</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                ...
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">Car Audio Systems</a></li>
                    <li><a href="{{ url('shop-grid') }}">Cellphones</a></li>
                    <li><a href="{{ url('shop-grid') }}">Desktops</a></li>
                    <li><a href="{{ url('shop-grid') }}">Gaming Consoles</a></li>
                    <li><a href="{{ url('shop-grid') }}">Telephones</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                ...
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">Player Accessories</a></li>
                    <li><a href="{{ url('shop-grid') }}">Computer Accessories</a></li>
                    <li><a href="{{ url('shop-grid') }}">Speakers & Audio</a></li>
                    <li><a href="{{ url('shop-grid') }}">Computer Networking</a></li>
                    <li><a href="{{ url('shop-grid') }}">Movies & Films</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                        ...
                        Software</span></a>
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">Android</a></li>
                    <li><a href="{{ url('shop-grid') }}">Linux & Unix</a></li>
                    <li><a href="{{ url('shop-grid') }}">Macintosh</a></li>
                    <li><a href="{{ url('shop-grid') }}">Windows</a></li>
                    <li><a href="{{ url('shop-grid') }}">iPhone & iOS</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                ...
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">Antenna Toppers</a></li>
                    <li><a href="{{ url('shop-grid') }}">Automotive Body Armor</a></li>
                    <li><a href="{{ url('shop-grid') }}">Power Inverter</a></li>
                    <li><a href="{{ url('shop-grid') }}">Gas Tank Doors</a></li>
                    <li><a href="{{ url('shop-grid') }}">Hood Scoops & Vents</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                ...
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">Computer CPU Processors</a></li>
                    <li><a href="{{ url('shop-grid') }}">Internal Fans & Cooling</a></li>
                    <li><a href="{{ url('shop-grid') }}">Graphics Cards</a></li>
                    <li><a href="{{ url('shop-grid') }}">Network I/O Port Cards</a></li>
                    <li><a href="{{ url('shop-grid') }}">Internal Memory Card</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                ...
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">Graphic PC</a></li>
                    <li><a href="{{ url('shop-grid') }}">Office PC</a></li>
                    <li><a href="{{ url('shop-grid') }}">Gaming PC</a></li>
                    <li><a href="{{ url('shop-grid') }}">Server</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                ...
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">JBL</a></li>
                    <li><a href="{{ url('shop-grid') }}">Anker</a></li>
                    <li><a href="{{ url('shop-grid') }}">Pyle</a></li>
                    <li><a href="{{ url('shop-grid') }}">Bose</a></li>
                    <li><a href="{{ url('shop-grid') }}">Logitech</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                ...
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">On-Ear Headphones</a></li>
                    <li><a href="{{ url('shop-grid') }}">In-Ear Headphones</a></li>
                    <li><a href="{{ url('shop-grid') }}">Earbud</a></li>
                    <li><a href="{{ url('shop-grid') }}">Over-Ear Headphones</a></li>
                    <li><a href="{{ url('shop-grid') }}">Other</a></li>
                </ul>
            </li>
            <li class="has-children"><a href="{{ url('shop-grid') }}"><span class="img-link"><img
                ...
                <ul class="sub-menu">
                    <li><a href="{{ url('shop-grid') }}">Copyholders</a></li>
                    <li><a href="{{ url('shop-grid') }}">Office Bookends</a></li>
                    <li><a href="{{ url('shop-grid') }}">Business Card Holders</a></li>
                    <li><a href="{{ url('shop-grid') }}">Lap Desks</a></li>
                    <li><a href="{{ url('shop-grid') }}">Mouse Pads</a></li>
                </ul>
            </li>
        </ul>
    </div>
