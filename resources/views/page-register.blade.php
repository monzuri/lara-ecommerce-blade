                ...
                <div class="row mb-100">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="form-register mt-30 mb-30">
                            ...
                            <div class="form-group">
                                <label>
                                    <input class="checkagree" type="checkbox">By clicking Register button, you agree our
                                    terms and policy,
                                </label>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="mt-20"><span class="font-xs color-gray-500 font-medium">Already have an
                                    account?</span><a class="font-xs color-brand-3 font-medium" href="page-login"> Sign
                                    In</a></div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="box-login-social pt-65 pl-50">
                            ...
                            <div class="box-button-login mt-25"><a
                                    class="btn btn-login font-md-bold color-brand-3 mb-15">Sign up
                                    with<img src="assets/imgs/page/account/google.svg" alt="Ecom"></a><a
                                    ...
                                    class="btn btn-login font-md-bold color-brand-3 mb-15">Sign up with<img
                                        src="assets/imgs/page/account/amazon.svg" alt="Ecom"></a></div>
