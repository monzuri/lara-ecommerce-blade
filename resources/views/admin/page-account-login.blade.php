        ...
        <section class="content-main">
            <div class="card mx-auto card-login">
                <div class="card-body">
                    ...
                    <div class="mb-3"><a class="float-end font-sm text-muted" href="{{ url('#') }}">Forgot
                            password?</a>
                    ...
                    <div class="d-grid gap-3 mb-4"><a class="btn w-100 btn-light font-sm" href="{{ url('#') }}">
                            <svg class="icon-svg" aria-hidden="true" width="20" height="20" viewbox="0 0 20 20">
                                ...
                                <path
                                    ...
                                    fill="#EA4335"></path>
                            </svg> Sign in using Google</a><a class="btn w-100 btn-light font-sm"
                            href="{{ url('#') }}">
                            <svg class="icon-svg" aria-hidden="true" width="20" height="20" viewbox="0 0 20 20">
                                <path
                    ...
                    <p class="text-center mb-4">Do not have account?<a href="{{ url('page-account-register.html') }}">
                            Sign up</a></p>
                </div>
            </div>
        </section>
