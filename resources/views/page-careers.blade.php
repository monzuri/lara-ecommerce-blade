            ...
            <div class="breadcrumbs-div">
                <div class="container">
                    <ul class="breadcrumb">
                        ...
                        <li><a class="font-xs color-gray-500" href="page-term">Careers</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-10 mx-auto page-content">
                        <h2 class="text-center mb-20">Work with us</h2><img class="mb-30"
                            src="assets/imgs/page/about/team-2.jpg" alt="Ecom">
                        <p>We recognize that poverty has no borders. Neither does excellence. We are continually in search
                            of the
                            brightest, most talented individuals from around the globe.</p>
                        ...
                        <p>To take a trivial example, which of us ever undertakes laborious physical exercise, except to
                            ...
                            pleasure that has
                            no annoying consequences, or one who avoids a pain that produces no resultant pleasure? On the
                            other hand,
                        ...
                        <p>To take a trivial example, which of us ever undertakes laborious physical exercise, except to
                            ...
                            bound to ensue; and equal blame belongs to those who fail in their duty through weakness of
                            will, which is
                            the same as saying through shrinking from toil and pain. These cases are perfectly simple and
                            easy to
