            ...
            <div class="breadcrumbs-div">
                <div class="container">
                    <ul class="breadcrumb">
                        ...
                        <li><a class="font-xs color-gray-500" href="page-about-us">About Us</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        ...
                        <div class="row mt-20">
                            <div class="col-lg-6">
                                <p class="font-sm font-medium color-gray-700 mb-15">Ecom expands global footprint,
                                    delivering
                                    entertaining experiences customised to each user. Branches are expanding both in size
                                    and number.</p>
                                <p class="font-sm font-medium color-gray-700 mb-15">Nunc vel risus commodo viverra maecenas
                                    accumsan
                                    lacus vel facilisis. Lacus vel facilisis volutpat est velit. Urna neque viverra justo
                                    nec. Suspendisse
                                    faucibus interdum posuere lorem ipsum dolor. Ut aliquam purus sit amet luctus venenatis
                                    lectus magna
                                    fringilla. Tortor vitae purus faucibus ornare.</p>
                                <p class="font-sm font-medium color-gray-700 mb-15">Tempus iaculis urna id volutpat lacus
                                    laoreet. Id
                                    neque aliquam vestibulum morbi blandit. Lacinia quis vel eros donec ac odio tempor orci.
                                    Lectus sit
                                    amet est placerat in egestas erat imperdiet. Nunc congue nisi vitae suscipit. Sed
                                    adipiscing diam
                                    donec adipiscing tristique risus.</p>
                        ...
                        <div class="row mb-50">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="card-staff hover-up">
                                    <div class="image-staff"><img src="assets/imgs/page/about/staft1.png" alt="Ecom">
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="card-staff hover-up">
                                    <div class="image-staff"><img src="assets/imgs/page/about/staft2.png" alt="Ecom">
                                    </div>
                                    <div class="info-staff">
                                        <h5>Jenny Wilson</h5>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="card-staff hover-up">
                                    <div class="image-staff"><img src="assets/imgs/page/about/staft3.png" alt="Ecom">
                                    </div>
                                    <div class="info-staff">
                                        <h5>Cody Fisher</h5>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="card-staff hover-up">
                                    <div class="image-staff"><img src="assets/imgs/page/about/staft4.png" alt="Ecom">
                                    </div>
                                    <div class="info-staff">
                                        <h5>Jacob Jones</h5>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="card-staff hover-up">
                                    <div class="image-staff"><img src="assets/imgs/page/about/staft5.png" alt="Ecom">
                                    </div>
                                    <div class="info-staff">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="card-staff hover-up">
                                    <div class="image-staff"><img src="assets/imgs/page/about/staft6.png" alt="Ecom">
                                    </div>
                                    <div class="info-staff">
                                        <h5>Ralph Edwards</h5>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="card-staff hover-up">
                                    <div class="image-staff"><img src="assets/imgs/page/about/staft7.png" alt="Ecom">
                                    </div>
                                    <div class="info-staff">
                                        <h5>Eleanor Pena</h5>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="card-staff hover-up">
                                    <div class="image-staff"><img src="assets/imgs/page/about/staft8.png" alt="Ecom">
                                    </div>
                                    <div class="info-staff">
                                        <h5>Theresa Webb</h5>
                        ...
                        <div class="box-images-logo"><a class="hover-up" href="shop-vendor-single"><img
                                    src="assets/imgs/page/about/microsoft.svg" alt="Ecom"></a><a class="hover-up"
                                href="shop-vendor-single"><img src="assets/imgs/page/about/sony.svg"
                                    alt="Ecom"></a><a class="hover-up" href="shop-vendor-single"><img
                                    src="assets/imgs/page/about/acer.svg" alt="Ecom"></a><a class="hover-up"
                                href="shop-vendor-single"><img src="assets/imgs/page/about/nokia.svg"
                                    alt="Ecom"></a><a class="hover-up" href="shop-vendor-single"><img
                                    src="assets/imgs/page/about/asus.svg" alt="Ecom"></a><a class="hover-up"
                                href="shop-vendor-single"><img src="assets/imgs/page/about/casio.svg"
                                    alt="Ecom"></a><a class="hover-up" href="shop-vendor-single"><img
                                    src="assets/imgs/page/about/dell.svg" alt="Ecom"></a><a class="hover-up"
                                href="shop-vendor-single"><img src="assets/imgs/page/about/panasonic.svg"
                                    alt="Ecom"></a><a class="hover-up" href="shop-vendor-single"><img
                                    src="assets/imgs/page/about/vaio.svg" alt="Ecom"></a><a class="hover-up"
                                href="shop-vendor-single"><img src="assets/imgs/page/about/sharp.svg" alt="Ecom"></a>
                        </div>
                        ...
                        <div class="col-lg-10">
                            <div class="row">
                                ...
                                <div class="col-lg-3 text-center mb-30">
                                    <div class="box-image mb-20"><img src="assets/imgs/page/contact/chat.svg"
                                            alt="Ecom"></div>
                                ...
                                <div class="col-lg-3 text-center mb-30">
                                    <div class="box-image mb-20"><img src="assets/imgs/page/contact/call.svg"
                                            alt="Ecom"></div>
                                ...
                                <div class="col-lg-3 text-center mb-30">
                                    <div class="box-image mb-20"><img src="assets/imgs/page/contact/map.svg"
                                            alt="Ecom"></div>
                                    <h4 class="mb-5">Visit us</h4>
                                    <p class="font-sm color-gray-700 mb-5">Visit our office</p><span
                                        class="font-sm color-gray-900">205
                                        North Michigan Avenue, Suite 810<br>Chicago, 60601, USA</span>
                                </div>
                            </div>
                        </div>
                    </div>
