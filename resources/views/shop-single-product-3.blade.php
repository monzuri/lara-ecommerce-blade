...
<main class="main">
    ...
    <section class="section-box shop-template">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="color-brand-3 mb-5 mw-80">Samsung Galaxy S22 Ultra 5G 128/256GB SM-S906U1 Unlocked Cell
                        Phones
                        All Colors - Good Condition</h3>
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 col-md-8 col-sm-7 text-center text-sm-start mb-mobile"><span
                                ...
                                class="byAUthor color-gray-900 font-xs font-medium" href="shop-vendor-single"> Ecom
                                Tech</a>
                            <div class="rating mt-5 d-inline-block mr-20"><img src="assets/imgs/template/icons/star.svg"
                ...
                <div class="col-lg-5">
                    ...
                    <div class="box-tags mt-15 mb-30">
                        ...
                        <div class="d-inline-block"><span class="font-sm font-medium color-gray-900">Tags:</span><a
                                class="link" href="#">Blue</a>,<a class="link"
                                href="#">Smartphone</a></div>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="row">
                        <div class="col-lg-7 col-md-7 mb-30">
                            ...
                            <div class="box-product-color">
                                ...
                                <ul class="list-colors">
                                    <li class="disabled"><img src="assets/imgs/page/product/img-thumb.png"
                                            alt="Ecom" title="Pink"></li>
                                    <li><img src="assets/imgs/page/product/img-thumb.png" alt="Ecom"
                                            title="Gold"></li>
                                    <li><img src="assets/imgs/page/product/img-thumb.png" alt="Ecom"
                                            title="Pink Gold"></li>
                                    <li><img src="assets/imgs/page/product/img-thumb.png" alt="Ecom"
                                            title="Silver"></li>
                                    <li class="active"><img src="assets/imgs/page/product/img-thumb.png"
                                            alt="Ecom" title="Pink Gold">
                                    </li>
                                    <li class="disabled"><img src="assets/imgs/page/product/img-thumb.png"
                                            alt="Ecom" title="Pink Gold">
                                    </li>
                            ...
                            <div class="buy-product mt-25">
                                ...
                                <div class="box-quantity">
                                    ...
                                    <div class="button-buy button-buy-full"><a class="btn btn-buy"
                                            href="shop-checkout">Buy now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pl-30 pl-mb-0">
                                <div class="box-featured-product">
                                    <div class="item-featured">
                                        <div class="featured-icon"><img src="assets/imgs/page/product/delivery.svg"
                                                alt="Ecom"></div>
                                        <div class="featured-info"><span class="font-sm-bold color-gray-1000">Free
                                                Delivery</span>
                                            <p class="font-sm color-gray-500 font-medium">From all orders over $10</p>
                                        </div>
                                    </div>
                                    <div class="item-featured">
                                        <div class="featured-icon"><img src="assets/imgs/page/product/support.svg"
                                                alt="Ecom"></div>
                                        <div class="featured-info"><span class="font-sm-bold color-gray-1000">Support
                                                24/7</span>
                                            <p class="font-sm color-gray-500 font-medium">Shop with an expert</p>
                                        </div>
                                    </div>
                                    <div class="item-featured">
                                        <div class="featured-icon"><img src="assets/imgs/page/product/return.svg"
                                                alt="Ecom"></div>
                                    ...
                                    <div class="item-featured">
                                        <div class="featured-icon"><img src="assets/imgs/page/product/payment.svg"
                                                alt="Ecom"></div>
                                        <div class="featured-info"><span class="font-sm-bold color-gray-1000">Secure
                                                payment</span>
                                ...
                                <div class="box-sidebar-product">
                                    <div class="banner-right h-500 text-center mb-30 banner-right-product"><span
                                        ...
                                        <h5 class="font-md-bold mt-10">Sensitive Touch<br
                                                class="d-none d-lg-block">without fingerprint
                                        </h5>
            ...
            <div class="box-bought-together">
                ...
                <div class="price-bought">
                    ...
                    <div class="box-btn-add-cart"><a class="btn btn-cart" href="shop-cart">Add To Cart</a></div>
                </div>
            </div>
            ...
            <div class="pt-30 mb-10">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="tab-description" role="tabpanel"
                        ...
                        <div class="display-text-short">
                            <p>It is a paradisematic country, in which roasted parts of sentences fly into your mouth.
                                ...
                                however a small line of blind text by the name of Lorem Ipsum decided to leave for the
                                far World of
                                Grammar. The Big Oxmox advised her not to do so, because there were thousands of bad
                                Commas, wild
                            ...
                            <p>When she reached the first hills of the Italic Mountains, she had a last view back on the
                                ...
                                word “and” and
                                the Little Blind Text should turn around and return to its own, safe country. It is a
                                paradisematic
                                country, in which roasted parts of sentences fly into your mouth. Even the all-powerful
                                Pointing has
                                no control about the blind texts it is an almost unorthographic life One day however a
                                small line of
                        ...
                        <div class="mt-20 text-center"><a
                                class="btn btn-border font-sm-bold pl-80 pr-80 btn-expand-more">More
                                Details</a></div>
                    </div>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="comment-list">
                                        <div class="single-comment justify-content-between d-flex mb-30 hover-up">
                                            <div class="user justify-content-between d-flex">
                                                <div class="thumb text-center"><img
                                                        src="assets/imgs/page/product/author-2.png" alt="Ecom"><a
                                                        class="font-heading text-brand" href="#">Sienna</a>
                                                </div>
                                                <div class="desc">
                                                    <div class="d-flex justify-content-between mb-10">
                                                        <div class="d-flex align-items-center"><span
                                                                class="font-xs color-gray-700">December 4,
                                                    ...
                                                    <p class="mb-10 font-sm color-gray-900">
                                                        ...
                                                        Delectus, suscipit
                                                        exercitationem accusantium obcaecati quos voluptate nesciunt
                                        ...
                                        <div
                                            ...
                                            <div class="user justify-content-between d-flex">
                                                <div class="thumb text-center"><img
                                                        src="assets/imgs/page/product/author-3.png" alt="Ecom"><a
                                        ...
                                        <div class="single-comment justify-content-between d-flex hover-up">
                                            <div class="user justify-content-between d-flex">
                                                <div class="thumb text-center"><img
                                                        src="assets/imgs/page/product/author-4.png" alt="Ecom"><a
                    ...
                    <div class="tab-pane fade" id="tab-vendor" role="tabpanel" aria-labelledby="tab-vendor">
                        <div class="vendor-logo d-flex mb-30"><img src="assets/imgs/page/product/futur.png"
                                alt="">
                            <div class="vendor-name ml-15">
                                <h6><a href="shop-vendor-single">Futur Tech.</a></h6>
                        ...
                        <ul class="contact-infor mb-50">
                            <li><img src="assets/imgs/page/product/icon-location.svg"
                                    alt=""><strong>Address:</strong><span> 5171 W
                                    Campbell Ave undefined Kent, Utah 53127 United States</span></li>
                            <li><img src="assets/imgs/page/product/icon-contact.svg" alt=""><strong>Contact
                                    Seller:</strong><span>
                        ...
                        <p class="font-sm color-gray-500 mb-15">
                            ...
                            American
                            noodle dishes and pasta in addition to soups and salads. Noodles &amp; Company was founded
                            in 1995 by
                        ...
                        <p class="font-sm color-gray-500">Proin congue dapibus rhoncus. Curabitur ipsum orci, malesuada
                            in
                            porttitor a, porttitor quis diam. Nunc at arcu ut turpis facilisis volutpat. Proin
                            tristique, mauris non
                            gravida dignissim, purus mauris malesuada tellus, in tincidunt orci enim eget ligula.
                            Quisque bibendum,
                            ipsum id malesuada placerat, purus felis vehicula risus, vel fringilla justo erat
                            ullamcorper ligula.
                    ...
                    <div class="list-products-5 mt-20">
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        ...
                                        href="shop-single-product-2">Dell Optiplex 9020 Small Form
                                        Business Desktop Tower</a>
                                    ...
                                    <div class="mt-20 box-btn-cart"><a class="btn btn-cart" href="shop-cart">Add To
                                            Cart</a></div>
                        ...
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        ...
                                        href="shop-single-product-2">HP 24 All-in-One PC, Intel Core
                                        i3-1115G4, 4GB RAM</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        ...
                                        href="shop-single-product-2">Gateway 23.8&quot; All-in-one
                        ...
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        href="shop-vendor-single">HP</a><br><a class="color-brand-3 font-sm-bold"
                                        href="shop-single-product-2">HP 22 All-in-One PC, Intel Pentium
                            ...
                            <div class="card-grid-inner">
                                ...
                                <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                        href="shop-single-product-2"><img src="assets/imgs/page/homepage1/imgsp7.png"
                                            alt="Ecom"></a></div>
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        href="shop-vendor-single">Sceptre</a><br><a class="color-brand-3 font-sm-bold"
                                        href="shop-single-product-2">Sceptre 24&quot; Professional Thin
                                        75Hz 1080p LED Monitor</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                    ...
                    <div class="list-products-5 mt-20">
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        ...
                                        href="shop-single-product-3">HP DeskJet 2755e Wireless Color
                        ...
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                                        href="shop-single-product-3">Razer Power Up Gaming Bundle V2 -
                                        Cynosa Lite</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                                        href="shop-single-product-3">Apple AirPods Pro with MagSafe
                                        Charging Case</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                                        href="shop-single-product-3">SAMSUNG Galaxy Tab A7 Lite,
                                        8.7&quot; Tablet 32GB</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                                        href="shop-single-product-3">HP 24mh FHD Monitor - Computer
                                        Monitor</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="card-grid-style-2 card-grid-none-border hover-up">
                                ...
                                <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                        class="color-brand-3 font-xs-bold" href="shop-single-product-3">SAMSUNG Galaxy
                                        Tab A7 Lite,
                                        8.7&quot; Tablet 32GB</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="card-grid-style-2 card-grid-none-border hover-up">
                                ...
                                <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                        class="color-brand-3 font-xs-bold" href="shop-single-product-3">Class 4K UHD
                                        (2160P) LED Roku
                                        Smart TV HDR</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="card-grid-style-2 card-grid-none-border hover-up">
                                ...
                                <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                        class="color-brand-3 font-xs-bold" href="shop-single-product-3">HP 24mh FHD
                                        Monitor - Computer
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="card-grid-style-2 card-grid-none-border hover-up">
                                ...
                                <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                        class="color-brand-3 font-xs-bold" href="shop-single-product-3">Logitech
                                        H390 Wired Headset,
                                        Stereo Headphones</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                    ...
                    <div class="list-products-5 mt-20">
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                        href="shop-single-product-3"><img
                                            src="assets/imgs/page/homepage1/imgsp3.png" alt="Ecom"></a></div>
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                                        href="shop-single-product-3">Logitech MK345 Wireless Combo
                                        Full-Sized Keyboard</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                                        href="shop-single-product-3">Logitech Brio 4K Webcam, Ultra 4K
                                        HD Video Calling</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                                        href="shop-single-product-3">2022 Apple iMac with Retina 5K
                                        Display 8GB RAM</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                                        href="shop-single-product-3">Seagate Portable 2TB External Hard
                                        Drive</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-w-1">
                            ...
                            <ul class="list-checkbox">
                                ...
                                <li>
                                    <label class="cb-container">
                                        <input type="checkbox" checked="checked"><span
                                            class="text-small">1&ndash;3 business
