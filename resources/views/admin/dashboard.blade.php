    ...
    <main class="main-wrap">
        <header class="main-header navbar">
            ...
            <div class="col-nav">
                ...
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link btn-icon" href="{{ url('#') }}"><i
                                class="material-icons md-notifications animation-shake"></i><span
                                class="badge rounded-pill">3</span></a></li>
                    <li class="nav-item"><a class="nav-link btn-icon darkmode" href="{{ url('#') }}"><i
                                class="material-icons md-nights_stay"></i></a></li>
                    <li class="nav-item"><a class="requestfullscreen nav-link btn-icon" href="{{ url('#') }}"><i
                    ...
                    <li class="dropdown nav-item"><a class="dropdown-toggle" id="dropdownLanguage" data-bs-toggle="dropdown"
                            href="{{ url('#') }}" aria-expanded="false"><i class="material-icons md-public"></i></a>
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownLanguage"><a
                                class="dropdown-item text-brand" href="{{ url('#') }}"><img
                                    src="{{ asset('/admin/assets/imgs/theme/flag-us.png') }}" alt="English">English</a><a
                                class="dropdown-item" href="{{ url('#') }}"><img
                                    src="{{ asset('/admin/assets/imgs/theme/flag-fr.png') }}"
                                    alt="Français">Fran&ccedil;ais</a><a class="dropdown-item"
                                href="{{ url('#') }}"><img src="{{ asset('/admin/assets/imgs/theme/flag-jp.png') }}"
                                    alt="Français">&#x65E5;&#x672C;&#x8A9E;</a><a class="dropdown-item"
                                href="{{ url('#') }}"><img src="{{ asset('/admin/assets/imgs/theme/flag-cn.png') }}"
                                    alt="Français">&#x4E2D;&#x56FD;&#x4EBA;</a></div>
                    </li>
                    <li class="dropdown nav-item"><a class="dropdown-toggle" id="dropdownAccount" data-bs-toggle="dropdown"
                            href="{{ url('#') }}" aria-expanded="false"><img class="img-xs rounded-circle"
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownAccount"><a
                                class="dropdown-item" href="{{ url('#') }}"><i
                                    class="material-icons md-perm_identity"></i>Edit
                                Profile</a><a class="dropdown-item" href="{{ url('#') }}"><i
                                    class="material-icons md-settings"></i>Account Settings</a><a class="dropdown-item"
                                href="{{ url('#') }}"><i
                                    class="material-icons md-account_balance_wallet"></i>Wallet</a><a class="dropdown-item"
                                href="{{ url('#') }}"><i class="material-icons md-receipt"></i>Billing</a><a
                                class="dropdown-item" href="{{ url('#') }}"><i
                                    class="material-icons md-help_outline"></i>Help
                                center</a>
                            <div class="dropdown-divider"></div><a class="dropdown-item text-danger"
                                href="{{ url('#') }}"><i class="material-icons md-exit_to_app"></i>Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <section class="content-main">
            <div class="content-header">
                ...
                <div><a class="btn btn-primary" href="{{ url('#') }}"><i
                                    ...
                                    <div class="new-member-list">
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex align-items-center"><img class="avatar"
                                                    src="{{ asset('/admin/assets/imgs/people/avatar4.jpg') }}"
                                                    alt="">
                                                <div>
                                                    <h6>Patric Adams</h6>
                                                    <p class="text-muted font-xs">Sanfrancisco</p>
                                                </div>
                                            </div><a class="btn btn-xs" href="{{ url('#') }}"><i
                                                    class="material-icons md-add"></i> Add</a>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex align-items-center"><img class="avatar"
                                                    src="{{ asset('/admin/assets/imgs/people/avatar2.jpg') }}"
                                                    alt="">
                                                <div>
                                                    <h6>Dilan Specter</h6>
                                                    <p class="text-muted font-xs">Sanfrancisco</p>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex align-items-center"><img class="avatar"
                                                    src="{{ asset('/admin/assets/imgs/people/avatar3.jpg') }}"
                                                    alt="">
                                                <div>
                                                    <h6>Tomas Baker</h6>
                                                    <p class="text-muted font-xs">Sanfrancisco</p>
                            ...
                            <table class="table align-middle table-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a class="fw-bold" href="{{ url('#') }}">#SK2540</a></td>
                                        <td>Neal Matthews</td>
                                        <td>07 Oct, 2022</td>
                                        <td>$400</td>
                                        ...
                                        <td><a class="btn btn-xs" href="{{ url('#') }}"> View details</a></td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">
                                            <div class="form-check">
                                        ...
                                        <td><a class="fw-bold" href="{{ url('#') }}">#SK2541</a></td>
                                        <td>Jamal Burnett</td>
                                        <td>07 Oct, 2022</td>
                                        <td>$380</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="fw-bold" href="{{ url('#') }}">#SK2542</a></td>
                                        <td>Juan Mitchell</td>
                                        <td>06 Oct, 2022</td>
                                        <td>$384</td>
                                        <td><span class="badge badge-pill badge-soft-success">Paid</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="fw-bold" href="{{ url('#') }}">#SK2543</a></td>
                                        <td>Barry Dick</td>
                                        <td>05 Oct, 2022</td>
                                        <td>$412</td>
                                        <td><span class="badge badge-pill badge-soft-success">Paid</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="fw-bold" href="{{ url('#') }}">#SK2544</a></td>
                                        <td>Ronald Taylor</td>
                                        <td>04 Oct, 2022</td>
                                        <td>$404</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="fw-bold" href="{{ url('#') }}">#SK2545</a></td>
                                        <td>Jacob Hunter</td>
                                        <td>04 Oct, 2022</td>
                                        <td>$392</td>
                                        <td><span class="badge badge-pill badge-soft-success">Paid</span></td>
            ...
            <div class="pagination-area mt-30 mb-50">
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-start">
                        ...
                        <li class="page-item"><a class="page-link dot" href="{{ url('#') }}">...</a></li>
                        <li class="page-item"><a class="page-link" href="{{ url('#') }}">16</a></li>
