        ...
        <section class="section-box shop-template">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <h3 class="color-brand-3 mb-25">Samsung 36" French door 28 cu. ft. Smart Energy Star Refrigerator
                        </h3><span class="bytext">by</span><a class="byAUthor" href="shop-vendor-single"> Ecom Tech</a>
                        <div class="rating mt-5"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                        ...
                        <div class="product-description mt-20 color-gray-900">– Lorem ipsum dolor sit amet, consectetur
                            adipiscing
                            elit.<br>– Nulla sit amet diam elementum, vehicula elit nec, accumsan velit.<br>– Integer
                            consectetur
                            lacus nec vestibulum auctor.<br>– Nulla suscipit tellus vel sem rhoncus auctor.</div>
                        ...
                        <div class="border-bottom pt-30 mb-20"></div><a class="mr-30" href="shop-wishlist"><span
                                class="btn btn-wishlist mr-5 opacity-100 transform-none"></span><span
                                class="font-md color-gray-900">Add
                                to Wish list</span></a><a href="shop-compare"><span
                                class="btn btn-compare mr-5 opacity-100 transform-none"></span><span
                                class="font-md color-gray-900">Add
                                to Compare</span></a>
                        <div class="info-product mt-20 font-md color-gray-900">SKU: EcomTech12321<br>Category:
                            Smartphones<br>Tags:
                            Blue, Smartphone</div>
                        <div class="mt-20"><a class="font-md color-gray-900" href="shop-compare">Compare with similar
                                items</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-bought-together">
                    <div class="box-product-bought">
                        <div class="product-bought"><img src="assets/imgs/page/product/img-bought.png" alt="Ecom">
                        </div>
                        <div class="product-bought"><img src="assets/imgs/page/product/img-bought2.png" alt="Ecom">
                        </div>
                    </div>
                        ...
                        <div class="row mt-40">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card-grid-style-2 card-grid-none-border hover-up">
                                    ...
                                    <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                            class="color-brand-3 font-xs-bold" href="shop-single-product-3">Logitech H390
                                            Wired Headset,
                                            Stereo Headphones</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
