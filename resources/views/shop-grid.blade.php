      ...
      <div class="breadcrumbs-div">
        <div class="container">
          <ul class="breadcrumb">
            ...
            <li><a class="font-xs color-gray-500" href="shop-grid">Electronics</a></li>
            <li><a class="font-xs color-gray-500" href="shop-grid">Cell phone</a></li>
            <li><a class="font-xs color-gray-500" href="shop-grid">Accessories</a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-9 order-first order-lg-last">
            <div class="banner-ads-top mb-30"><a href="shop-single-product-3"><img
                  src="assets/imgs/page/shop/banner.png" alt="Ecom"></a></div>
