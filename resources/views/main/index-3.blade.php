            ...
            <div class="swiper-wrapper pt-5">
              <div class="swiper-slide">
                <div class="box-slide-bg-1"><span class="label-green text-uppercase">new arrival</span>
                  ...
                  <div class="mt-30 mb-120"><a class="btn btn-brand-2 btn-gray-1000" href="shop-grid">Shop now</a><a
                      class="btn btn-link text-underline" href="shop-grid">Learn more</a></div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="box-slide-bg-1"><span class="label-green text-uppercase">new arrival</span>
      ...
      <div class="row">
        ...
        <div class="col-xl-5 col-lg-5 col-md-6 col-sm-12 mb-30">
          <div class="bg-20 pt-30 box-bdrd-4 block-kitchen">
            ...
            </p><a class="btn btn-link font-xs pl-0 text-uppercase color-brand-1" href="shop-grid">learn more</a>
          </div>
        </div>
        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12">
          <div class="bg-21 pt-30 box-bdrd-4 block-electric"><span class="font-sm color-brand-3">Starting from
              $82</span>
            <h3 class="font-xl mb-5">Electric Kettles</h3>
            <p class="font-16 mb-10">High capacity electric kettles for boiling water</p><a
              class="btn btn-link font-xs pl-0 text-uppercase color-brand-1" href="shop-grid">learn more</a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="list-products-5">
            <div class="card-grid-style-3 hover-show hover-hide-show-cart">
              <div class="card-grid-inner">
                <div class="tools"><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist"
                    aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare"
                ...
                <div class="image-box"><span class="label bg-brand-2">-10%</span><a href="shop-single-product-3"><img
                ...
                <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                    class="color-brand-3 font-sm-bold" href="#">2022 Apple iMac with Retina 5K Display 8GB RAM</a>
                  ...
                  <div class="mt-20 box-add-cart"><a class="btn btn-cart" href="shop-cart">Add To Cart</a></div>
            ...
            <div class="card-grid-style-3 hover-show hover-hide-show-cart">
              <div class="card-grid-inner">
                <div class="tools"><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist"
                    ...
                    aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view"
                    href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                <div class="image-box"><span class="label bg-brand-2">-5%</span><a href="shop-single-product-3"><img
                      src="assets/imgs/page/homepage1/imgsp4.png" alt="Ecom"></a></div>
                <div class="box-count">
                  <div class="deals-countdown" data-countdown="2023/09/25 00:00:00"></div>
                </div>
                <div class="info-right"><span class="font-xs color-gray-500">Philips</span><br><a
                    class="color-brand-3 font-sm-bold" href="#">Philips H4205 On-Ear Wireless Headphones with 32mm
                    V201</a>
                  <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      ...
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">
                      (65)</span></div>
                  <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$170.3</strong><span
                      class="color-gray-500 price-line">$173.2</span></div>
                  <div class="box-progress box-progress-small">
                    <div class="progress-bar">
                      <div class="progress-bar-inner"></div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-end"><span
                          class="font-xs color-gray-500">Sold:</span><span
                          class="font-xs-bold color-gray-900">125</span></div>
                    </div>
                  </div>
                  <div class="mt-20 box-add-cart"><a class="btn btn-cart" href="shop-cart">Add To Cart</a></div>
                  <ul class="list-features">
            ...
            <div class="card-grid-style-3 hover-show hover-hide-show-cart">
              <div class="card-grid-inner">
                <div class="tools"><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist"
                    ...
                    aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view"
                    href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                <div class="image-box"><span class="label bg-brand-2">-15%</span><a href="shop-single-product-3"><img
                      src="assets/imgs/page/homepage1/imgsp5.png" alt="Ecom"></a></div>
                <div class="box-count">
                  <div class="deals-countdown" data-countdown="2023/09/25 00:00:00"></div>
                </div>
                <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                    class="color-brand-3 font-sm-bold" href="#">2020 Apple MacBook Air Laptop: Apple M1 Chip, 13”</a>
                  <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">
                      (65)</span></div>
                  <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$169</strong><span
                      class="color-gray-500 price-line">$225</span></div>
                  <div class="box-progress box-progress-small">
                    <div class="progress-bar">
                      <div class="progress-bar-inner"></div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-end"><span
                          class="font-xs color-gray-500">Sold:</span><span
                          class="font-xs-bold color-gray-900">16</span></div>
                    </div>
                  </div>
                  <div class="mt-20 box-add-cart"><a class="btn btn-cart" href="shop-cart">Add To Cart</a></div>
                  <ul class="list-features">
            ...
            <div class="card-grid-style-3 hover-show hover-hide-show-cart">
              <div class="card-grid-inner">
                <div class="tools"><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist"
                    ...
                    aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view"
                    href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3"><img
                      src="assets/imgs/page/homepage1/imgsp6.png" alt="Ecom"></a></div>
                <div class="box-count">
                  <div class="deals-countdown" data-countdown="2023/09/25 00:00:00"></div>
                </div>
                <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                    class="color-brand-3 font-sm-bold" href="#">Apple Watch Series 8 [GPS 45mm] Smart Watch</a>
                  <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">
                      (65)</span></div>
                  <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2514.3</strong><span
                      class="color-gray-500 price-line">$2756.6</span></div>
                  <div class="box-progress box-progress-small">
                    <div class="progress-bar">
                      <div class="progress-bar-inner"></div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-end"><span
                          class="font-xs color-gray-500">Sold:</span><span
                          class="font-xs-bold color-gray-900">185</span></div>
                    </div>
                  </div>
                  <div class="mt-20 box-add-cart"><a class="btn btn-cart" href="shop-cart">Add To Cart</a></div>
                  <ul class="list-features">
            ...
            <div class="card-grid-style-3 hover-show hover-hide-show-cart">
              <div class="card-grid-inner">
                <div class="tools"><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist"
                    ...
                    aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view"
                    href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                <div class="image-box"><span class="label bg-brand-2">-30%</span><a href="shop-single-product-3"><img
                      src="assets/imgs/page/homepage1/imgsp7.png" alt="Ecom"></a></div>
                <div class="box-count">
                  <div class="deals-countdown" data-countdown="2023/09/25 00:00:00"></div>
                </div>
                <div class="info-right"><span class="font-xs color-gray-500">Kami Tech</span><br><a
                    class="color-brand-3 font-sm-bold" href="#">Kami by YI 4pc 1080p Home Security Cameras</a>
                  <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">
                      (65)</span></div>
                  <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$115.0</strong><span
                      class="color-gray-500 price-line">$125.6</span></div>
                  <div class="box-progress box-progress-small">
                    <div class="progress-bar">
                      <div class="progress-bar-inner"></div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-end"><span
                          class="font-xs color-gray-500">Sold:</span><span
                          class="font-xs-bold color-gray-900">68</span></div>
                    </div>
                  </div>
                  <div class="mt-20 box-add-cart"><a class="btn btn-cart" href="shop-cart">Add To Cart</a></div>
                  <ul class="list-features">
              ...
              <div class="card-grid-style-3 hover-show hurry-up hurry-up-2">
                <div class="card-grid-inner">
                  <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a
                      class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist"
                      aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10"
                      href="shop-compare" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip"
                  ...
                  <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                      class="color-brand-3 font-sm-bold" href="shop-single-product-3">
                    ...
                    </ul><a class="btn btn-cart" href="shop-cart">Add To Cart</a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="card-grid-style-3">
                    <div class="card-grid-inner">
                      ...
                      <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                          href="shop-single-product-3"><img src="assets/imgs/page/homepage3/sp7.png" alt="Ecom"></a>
                      </div>
                      <div class="box-count">
                        <div class="deals-countdown" data-countdown="2022/12/25 00:00:00"></div>
                      </div>
                      <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                          class="color-brand-3 font-sm-bold" href="shop-single-product-3">2022 Apple iMac with Retina
                        ...
                        <div class="price-info"><strong
                            ...
                            class="color-gray-500 price-line">$3225.6</span></div>
                        <div class="mt-20"><a class="btn btn-cart" href="shop-cart">Add To Cart</a></div>
                        <ul class="list-features">
                          <li> 27-inch (diagonal) Retina 5K display</li>
                        </ul>
                      </div>
                  ...
                  <div class="card-grid-style-3">
                    <div class="card-grid-inner">
                      <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a
                          ...
                          aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                      <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                          href="shop-single-product-3"><img src="assets/imgs/page/homepage3/sp8.png" alt="Ecom"></a>
                      </div>
                      <div class="box-count">
                        <div class="deals-countdown" data-countdown="2022/12/25 00:00:00"></div>
                      </div>
                      <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                          class="color-brand-3 font-sm-bold" href="shop-single-product-3">Hamilton Beach Smoothie
                  ...
                  <div class="card-grid-style-3">
                    <div class="card-grid-inner">
                      <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a
                          ...
                          aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                      <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                          href="shop-single-product-3"><img src="assets/imgs/page/homepage3/sp9.png" alt="Ecom"></a>
                      </div>
                      <div class="box-count">
                        <div class="deals-countdown" data-countdown="2022/12/25 00:00:00"></div>
                      </div>
                      <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                          class="color-brand-3 font-sm-bold" href="shop-single-product-3">. BPA-Free Plastic Jar,
                  ...
                  <div class="card-grid-style-3">
                    <div class="card-grid-inner">
                      <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a
                          ...
                          aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                      <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                          href="shop-single-product-3"><img src="assets/imgs/page/homepage3/sp4.png" alt="Ecom"></a>
                      </div>
                      <div class="box-count">
                        <div class="deals-countdown" data-countdown="2022/12/25 00:00:00"></div>
                      </div>
                      <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                          class="color-brand-3 font-sm-bold" href="shop-single-product-3">Portable Blender USB
                  ...
                  <div class="card-grid-style-3">
                    <div class="card-grid-inner">
                      <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a
                          ...
                          aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                      <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                          href="shop-single-product-3"><img src="assets/imgs/page/homepage3/sp5.png" alt="Ecom"></a>
                      </div>
                      <div class="box-count">
                        <div class="deals-countdown" data-countdown="2022/12/25 00:00:00"></div>
                      </div>
                      <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                          class="color-brand-3 font-sm-bold" href="shop-single-product-3">Ninja Professional 1000-Watt
                          Blender Fruit Vegetable Machine, BL710WM</a>
                        <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                            src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                            src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                            src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                  ...
                  <div class="card-grid-style-3">
                    <div class="card-grid-inner">
                      <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a
                          ...
                          aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                      <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                          href="shop-single-product-3"><img src="assets/imgs/page/homepage3/sp6.png" alt="Ecom"></a>
                      </div>
                      <div class="box-count">
                        <div class="deals-countdown" data-countdown="2022/12/25 00:00:00"></div>
                      </div>
                      <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                          class="color-brand-3 font-sm-bold" href="shop-single-product-3">Suzicca 500mL Portable
                          Juicer Electric Mixer Cup USB Smoothie Blender Shakes Handheld</a>
                        <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                            src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                            src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                            src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card-grid-style-3">
                <div class="card-grid-inner">
                  ...
                  <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                      class="color-brand-3 font-sm-bold" href="shop-single-product-3">2022 Apple iMac with Retina 5K
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card-grid-style-3">
                <div class="card-grid-inner">
                  ...
                  <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                      class="color-brand-3 font-sm-bold" href="shop-single-product-3">Hamilton Beach Smoothie Electric
                      Blender with 10 Speeds, 56 oz</a>
                    <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                        src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                        src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                        src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card-grid-style-3">
                <div class="card-grid-inner">
                  ...
                  <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                      class="color-brand-3 font-sm-bold" href="shop-single-product-3">. BPA-Free Plastic Jar, Model
                      50190 11914.2 out of 5 Stars</a>
                    <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                        src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                        src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                        src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card-grid-style-3">
                <div class="card-grid-inner">
                  ...
                  <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                      class="color-brand-3 font-sm-bold" href="shop-single-product-3">Suzicca 500mL Portable Juicer
                      Electric Mixer Cup USB Smoothie Blender Shakes Handheld Fruit Vegetable Machine</a>
                    <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                        src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                        src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                        src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
  ...
  <section class="section-box mt-30">
    <div class="container">
      <div class="banner-ads text-center">
        ...
        <div class="mt-20"><a class="btn btn-brand-2 btn-arrow-right" href="shop-grid">Shop Now</a></div>
      </div>
    </div>
  </section>
                    ...
                    <div class="card-grid-style-3 card-ads-1">
                      <div class="card-grid-inner text-center">
                        ...
                        <div class="mt-30"><a class="btn btn-brand-2 btn-arrow-right"
                            href="shop-single-product-2">Shop Now</a></div>
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            class="btn btn-compare btn-tooltip mb-10" href="shop-compare" aria-label="Compare"></a><a
                            class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview"
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product-2"><img src="assets/imgs/page/homepage1/imgsp1.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product-2">HP 11.6&quot; Chromebook, AMD A4, 4GB RAM, 32GB Storage</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                          ...
                          <div class="price-info"><strong
                              class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span
                              class="color-gray-500 price-line">$3225.6</span></div>
                          <div class="mt-20 box-btn-cart"><a class="btn btn-cart" href="shop-cart">Add To Cart</a>
                          </div>
                          <ul class="list-features">
                            <li>27-inch (diagonal) Retina 5K display</li>
                            <li>3.1GHz 6-core 10th-generation Intel Core i5</li>
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product-2"><img src="assets/imgs/page/homepage1/imgsp2.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product-2">ASUS VivoBook 15.6&quot; 1080p PC Laptops, Intel Core i3</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product-2"><img src="assets/imgs/page/homepage1/imgsp3.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product-2">2020 Apple 10.9-inch iPad Air Wi-Fi 64GB - Silver</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product-2"><img src="assets/imgs/page/homepage1/imgsp4.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product-2">MSI Optix G272 27&quot; Full HD LED Gaming LCD Monitor</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product-2"><img src="assets/imgs/page/homepage1/imgsp5.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product-2">2022 Apple iMac with Retina 5K Display 8GB RAM, 256GB SSD</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product-2"><img src="assets/imgs/page/homepage1/imgsp6.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product-2">2022 Apple iMac with Retina 5K Display 8GB RAM, 256GB SSD</a>
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product-2"><img src="assets/imgs/page/homepage1/imgsp7.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product-2">2022 Apple iMac with Retina 5K Display 8GB RAM, 256GB SSD</a>
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product-2"><img src="assets/imgs/page/homepage1/imgsp8.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product-2">2022 Apple iMac with Retina 5K Display 8GB RAM, 256GB SSD</a>
    ...
    <div class="container">
      <div class="head-main bd-gray-200">
        <div class="row">
          ...
          <div class="col-xl-6 col-lg-6">
            <ul class="nav nav-tabs text-uppercase pr-100" role="tablist">
              <li><a class="active" href="#tab-4-all" data-bs-toggle="tab" role="tab" aria-controls="tab-4-all"
                  aria-selected="true" data-index="5">All</a></li>
              <li><a href="#tab-4-bestseller" data-bs-toggle="tab" role="tab" aria-controls="tab-4-bestseller"
                  aria-selected="false" data-index="6">Best seller</a></li>
              <li><a href="#tab-4-mostviewed" data-bs-toggle="tab" role="tab" aria-controls="tab-4-mostviewed"
                  aria-selected="false" data-index="7">Most viewed</a></li>
              <li><a href="#tab-4-topbrands" data-bs-toggle="tab" role="tab" aria-controls="tab-4-topbrands"
                  aria-selected="false" data-index="8">Top Brands</a></li>
            </ul>
            <!-- Button slider-->
            <div class="box-button-slider">
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product"><img src="assets/imgs/page/homepage1/imgsp3.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product">Apple Watch Series 7 GPS + Cellular, 41mm</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product"><img src="assets/imgs/page/homepage1/imgsp4.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product">ASUS VivoBook 15.6&quot; 1080p PC Laptops, Intel Core i3</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product"><img src="assets/imgs/page/homepage1/imgsp5.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product">Bose Sport Earbuds True Wireless Bluetooth Headphones</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product"><img src="assets/imgs/page/homepage1/imgsp6.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product">RCA 43&quot; Class 4K Ultra HD (2160P) HDR Roku Smart </a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product"><img src="assets/imgs/page/homepage1/imgsp7.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product">Hisense 43&quot; Class 4K UHD LED XClass Smart TV HDR A6</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                  ...
                  <div class="row mt-10">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      <div class="card-grid-style-2">
                        ...
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                            class="color-brand-3 font-sm-bold" href="shop-single-product">2020 Apple 10.9-inch iPad
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      <div class="card-grid-style-2">
                        ...
                        <div class="info-right"><span class="font-xs color-gray-500">Chromecast</span><br><a
                            class="color-brand-3 font-sm-bold" href="shop-single-product">Chromecast with Google TV -
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      <div class="card-grid-style-2">
                        ...
                        <div class="info-right"><span class="font-xs color-gray-500">LG </span><br><a
                            class="color-brand-3 font-sm-bold" href="shop-single-product">LG 65&quot; Class 4K UHD
                            Smart TV OLED A1 Series OLED65A1PUA</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      <div class="card-grid-style-2">
                        <div class="image-box"><a href="shop-single-product"><img
                              src="assets/imgs/page/homepage1/imgsp2.png" alt="Ecom"></a></div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                            class="color-brand-3 font-sm-bold" href="shop-single-product">SAMSUNG 30-100 inches The
                            Freestyle Smart Portable</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      <div class="card-grid-style-2">
                        <div class="image-box"><a href="shop-single-product"><img
                              src="assets/imgs/page/homepage1/imgsp1.png" alt="Ecom"></a></div>
                        <div class="info-right"><span class="font-xs color-gray-500">Lenovo</span><br><a
                            class="color-brand-3 font-sm-bold" href="shop-single-product">Lenovo Legion 5i 15.6&quot;
                            Laptop, Intel Core i5-10500H</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      <div class="card-grid-style-2">
                        ...
                        <div class="info-right"><span class="font-xs color-gray-500">SAMSUNG</span><br><a
                            class="color-brand-3 font-sm-bold" href="shop-single-product">SAMSUNG Galaxy Tab A7 Lite,
                            8.7&quot; Tablet 32GB (Wi-Fi)</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product"><img src="assets/imgs/page/homepage1/imgsp1.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product">Apple Watch Series 7 GPS + Cellular, 41mm</a>
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product"><img src="assets/imgs/page/homepage1/imgsp2.png"
                              alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product">ASUS VivoBook 15.6&quot; 1080p PC Laptops, Intel Core i3</a>
                  ...
                  <div class="list-products-5">
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        ...
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="shop-single-product">2022 Apple iMac with Retina 5K Display 8GB RAM, 256GB SSD</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      <div class="card-grid-style-2">
                        <div class="image-box"><a href="shop-single-product"><img
                              src="assets/imgs/page/homepage1/imgsp1.png" alt="Ecom"></a></div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                            class="color-brand-3 font-sm-bold" href="shop-single-product">2022 Apple iMac with Retina
                            5K Display 8GB RAM, 256GB SSD</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
    ...
    <div class="container">
      <div class="head-main bd-gray-200">
        <div class="row">
          ...
          <div class="col-xl-6 col-lg-6">
            <ul class="nav nav-tabs text-uppercase pr-100" role="tablist">
              <li><a class="active" href="#tab-5-all" data-bs-toggle="tab" role="tab" aria-controls="tab-5-all"
                  aria-selected="true" data-index="9">All</a></li>
              <li><a href="#tab-5-bestseller" data-bs-toggle="tab" role="tab" aria-controls="tab-5-bestseller"
                  aria-selected="false" data-index="10">Best seller</a></li>
              <li><a href="#tab-5-mostviewed" data-bs-toggle="tab" role="tab" aria-controls="tab-5-mostviewed"
                  aria-selected="false" data-index="11">Most viewed</a></li>
              <li><a href="#tab-5-topbrands" data-bs-toggle="tab" role="tab" aria-controls="tab-5-topbrands"
                  aria-selected="false" data-index="12">Top Brands</a></li>
            </ul>
            <!-- Button slider-->
            <div class="box-button-slider">
                  ...
                  <div class="list-products-5">
                    <div class="card-grid-style-3 card-ads-2">
                      <div class="card-grid-inner">
                        ...
                        <div class="image-box"><a href="#"><img src="assets/imgs/page/homepage3/img-girl.png"
                              alt="Ecom"></a></div>
                      </div>
                    </div>
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview"
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="#"><img
                              src="assets/imgs/page/homepage3/img-tool1.png" alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold" href="#">MSI
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="#"><img
                              src="assets/imgs/page/homepage3/img-tool2.png" alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold" href="#">2022
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="#"><img
                              src="assets/imgs/page/homepage3/img-tool3.png" alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold" href="#">Bose
                            Sport Earbuds True Wireless Bluetooth Headphones</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                            ...
                            data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="#"><img
                              src="assets/imgs/page/homepage3/img-tool4.png" alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="#">Chromecast with Google TV - Streaming Entertainment</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                  ...
                  <div class="list-products-5">
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        ...
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="#"><img
                              src="assets/imgs/page/homepage3/img-tool4.png" alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold" href="#">RCA
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        ...
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="#">Class 4K UHD (2160P) LED Roku Smart TV HDR</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        ...
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="#">SAMSUNG Galaxy Tab S7 Plus 12.4&quot; 128GB Mystic Black</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        ...
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="#"><img
                              src="assets/imgs/page/homepage3/img-tool1.png" alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold" href="#">HP
                  ...
                  <div class="list-products-5">
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        ...
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="#">Hisense 43&quot; Class 4K UHD LED XClass Smart</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        ...
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="#"><img
                              src="assets/imgs/page/homepage3/img-tool1.png" alt="Ecom"></a></div>
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold" href="#">Dell
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        ...
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold" href="#">2022
                            Apple 10.9-inch iPad Air Wi-Fi 64GB</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                  ...
                  <div class="list-products-5">
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        ...
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="#">SAMSUNG Galaxy Tab A7 Lite, 8.7&quot; Tablet 32GB</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                    ...
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        ...
                        <div class="info-right"><a class="font-xs color-gray-500"
                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                            href="#">Razer Power Up Gaming Bundle V2 - Cynosa Lite</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                              src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="block-ads-1">
            <h4 class="color-gray-1000 mb-10">Make Everyday A Fine<br class="d-none d-lg-block"> Dining Experience
            </h4>
            <p class="color-border-1">With Our Kitchen Appliances</p>
            <div class="mt-25"><a class="btn btn-brand-2 btn-arrow-right" href="shop-list-2">Shop Now</a></div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="block-ads-2">
            <h4 class="color-gray-1000 mb-10">Be the best gift giver<br class="d-none d-lg-block">this Wedding Season!
            </h4>
            <p class="color-border-1">With Our Kitchen Appliances</p>
            <div class="mt-25"><a class="btn btn-brand-2 btn-arrow-right" href="shop-list-2">Shop Now</a></div>
          </div>
          ...
          <div class="swiper-wrapper pt-5">
            <div class="swiper-slide">
              <div class="card-grid-style-1">
                <div class="image-box"><a href="blog-single-2"></a><img src="assets/imgs/page/blog/blog-1.jpg"
                    alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list">Technology</a><a
                  class="color-gray-1100" href="blog-single-2">
            ...
            <div class="swiper-slide">
              <div class="card-grid-style-1">
                <div class="image-box"><a href="blog-single-3"></a><img src="assets/imgs/page/blog/blog-3.jpg"
                    alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list">Gaming</a><a class="color-gray-1100"
                  href="blog-single-3">
            ...
            <div class="swiper-slide">
              <div class="card-grid-style-1">
                <div class="image-box"><a href="blog-single-2"></a><img src="assets/imgs/page/blog/blog-4.jpg"
                    alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list">Blockchain</a><a
                  class="color-gray-1100" href="blog-single-2">
            ...
            <div class="swiper-slide">
              <div class="card-grid-style-1">
                <div class="image-box"><a href="blog-single-2"></a><img src="assets/imgs/page/blog/blog-5.jpg"
                    alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list">Development</a><a
                  class="color-gray-1100" href="blog-single-2">
          ...
          <div class="box-swiper">
            <div class="swiper-container swiper-group-10">
              <div class="swiper-wrapper">
                <div class="swiper-slide"><a href="shop-grid"><img src="assets/imgs/slider/logo/microsoft.svg"
                      alt="Ecom"></a></div>
                <div class="swiper-slide"><a href="shop-grid"><img src="assets/imgs/slider/logo/sony.svg"
                      alt="Ecom"></a></div>
                <div class="swiper-slide"><a href="shop-grid"><img src="assets/imgs/slider/logo/acer.svg"
                      alt="Ecom"></a></div>
                <div class="swiper-slide"><a href="shop-grid"><img src="assets/imgs/slider/logo/nokia.svg"
                      alt="Ecom"></a></div>
                <div class="swiper-slide"><a href="shop-grid"><img src="assets/imgs/slider/logo/assus.svg"
                      alt="Ecom"></a></div>
                <div class="swiper-slide"><a href="shop-grid"><img src="assets/imgs/slider/logo/casio.svg"
                      alt="Ecom"></a></div>
                <div class="swiper-slide"><a href="shop-grid"><img src="assets/imgs/slider/logo/dell.svg"
                      alt="Ecom"></a></div>
                <div class="swiper-slide"><a href="shop-grid"><img src="assets/imgs/slider/logo/panasonic.svg"
                      alt="Ecom"></a></div>
                <div class="swiper-slide"><a href="shop-grid"><img src="assets/imgs/slider/logo/vaio.svg"
                      alt="Ecom"></a></div>
                <div class="swiper-slide"><a href="shop-grid"><img src="assets/imgs/slider/logo/sharp.svg"
                      alt="Ecom"></a></div>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-6">
              <div class="product-info">
                ...
                <div class="info-by"><span class="bytext color-gray-500 font-xs font-medium">by</span><a
                    class="byAUthor color-gray-900 font-xs font-medium" href="shop-vendor-list"> Ecom Tech</a>
                  <div class="rating d-inline-block"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><img
                      src="assets/imgs/template/icons/star.svg" alt="Ecom"><span
                ...
                <div class="buy-product mt-5">
                  ...
                  <div class="box-quantity">
                    ...
                    <div class="button-buy"><a class="btn btn-cart" href="shop-cart">Add to cart</a><a
                        class="btn btn-buy" href="shop-checkout">Buy now</a></div>
                  </div>
                </div>
              </div>
            </div>
