                        ...
                        <div class="swiper-wrapper pt-5">
                            <div class="swiper-slide">
                                <div class="card-grid-style-2"><span class="label bg-brand-2">-12%</span>
                                    ...
                                    <div class="info-right"><span class="font-xs color-gray-500">YSSOA Store</span><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product">Chair Mesh
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-style-2"><span class="label bg-brand-2">-17%</span>
                                    ...
                                    <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product">Straight Talk
                                            Samsung Galaxy A03s,
                                            32GB, Black</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-style-2"><span class="label bg-brand-2">-20%</span>
                                    ...
                                    <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product">iMac MNE92LL/A 27
                                            Inch, 3.4 GHz
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-style-2"><span class="label bg-brand-2">-22%</span>
                                    ...
                                    <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product">Apple Watch
                                            Series 8 [GPS 45mm]
                    ...
                    <div class="col-lg-9">
                        <div class="banner-top-gray-100">
                            <div class="banner-ads-top mb-30"><a href="#"><img
                                        src="assets/imgs/page/shop/grid-2/banner.png" alt="Ecom"></a></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="box-filters mt-0 pb-5 border-bottom">
                            <div class="row">
                                ...
                                <div class="col-xl-10 col-lg-9 mb-10 text-lg-end text-center"><span
                                        class="font-sm color-gray-900 font-medium border-1-right span">Showing 1&ndash;16
                                        of 17
                                        results</span>
                                    ...
                                    <div class="d-inline-block"><a class="view-type-grid mr-5 active"
                                            href="shop-grid"></a><a class="view-type-list" href="shop-list"></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-20">
                                ...
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                ...
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Dell
                                                Optiplex 9020 Small Form
                                                Business Desktop</a>
                                            <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">HP 24
                                                All-in-One PC, Intel Core
                                                i3-1115G4</a>
                                            <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Gateway
                                                23.8&quot; All-in-one
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">HP 22
                                                All-in-One PC, Intel Pentium
                                                Silver J5040</a>
                                            <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">HP Slim
                                                Desktop, Intel Celeron
                                                J4025, 4GB RAM</a>
                                            <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Class 4K UHD
                                                (2160P) LED Roku
                                                Smart TV HDR</a>
                                            <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Galaxy Tab
                                                S7 Plus 12.4&quot;
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">MSI Optix
                                                G272 27&quot; Full HD
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">RCA 43&quot;
                                                Class 4K Ultra HD
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Bose Sport
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Hisense
                                                43&quot; Class 4K UHD LED
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Chromecast
                                                with Google TV -
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">LG 65&quot;
                                                Class 4K UHD Smart TV
                                                OLED A1 Series</a>
                                            <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">HDR Smart
                                            ...
                                            <div class="mt-20 box-btn-cart"><a class="btn btn-cart"
                                                    href="shop-cart">Add To Cart</a></div>
                                            <ul class="list-features">
                                                <li>27-inch (diagonal) Retina 5K display</li>
                                                <li>3.1GHz 6-core 10th-generation Intel Core i5</li>
                                                <li>AMD Radeon Pro 5300 graphics</li>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Seagate
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">SanDisk
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Original
                                                HP 63XL Black High-yield
                                                Ink Cartridge</a>
                                            <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                                    alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Logitech
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                href="shop-vendor-single">Apple</a><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">HP 24mh
                                                FHD Monitor - Computer
                    ...
                    <div class="col-lg-3 order-last order-lg-first">
                                        ...
                                        <div class="swiper-wrapper pt-5">
                                            <div class="swiper-slide">
                                                ...
                                                <div class="card-grid-style-2 card-grid-none-border border-bottom mb-10">
                                                    ...
                                                    <div class="info-right"><a class="color-brand-3 font-xs-bold"
                                                            href="shop-single-product-3">Class 4K UHD (2160P) LED Roku
                                                            Smart TV HDR</a>
                                                        <div class="rating"><img
                                                                src="assets/imgs/template/icons/star.svg"
                                                                alt="Ecom"><img
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card-grid-style-2 card-grid-none-border border-bottom mb-10">
                                                    ...
                                                    <div class="info-right"><a class="color-brand-3 font-xs-bold"
                                                            href="shop-single-product-3">Lenovo Legion 5i 15.6&quot;
                                                            Laptop, Intel Core i5</a>
                                                        <div class="rating"><img
                                                                src="assets/imgs/template/icons/star.svg"
                                                                alt="Ecom"><img
                        ...
                        <div class="box-slider-item">
                            ...
                            <div class="content-slider mb-50"><a class="btn btn-border mr-5"
                                    href="shop-grid">Games</a><a class="btn btn-border mr-5"
                                    href="shop-grid">Electronics</a><a class="btn btn-border mr-5"
                                    href="shop-grid">Video</a><a class="btn btn-border mr-5"
                                    href="shop-grid">Cellphone</a><a class="btn btn-border mr-5"
                                    href="shop-grid">Indoor</a><a class="btn btn-border mr-5" href="shop-grid">VGA
                                    Card</a><a class="btn btn-border mr-5" href="shop-grid">USB</a><a
                                    class="btn btn-border mr-5" href="shop-grid">Lightning</a><a
                                    class="btn btn-border mr-5" href="shop-grid">Camera</a><a class="btn btn-border"
                                    href="shop-grid">Window</a><a class="btn btn-border mr-5" href="shop-grid">Air
                                    Vent</a><a class="btn btn-border mr-5" href="shop-grid">Bedroom</a><a
                                    class="btn btn-border mr-5" href="shop-grid">Laptop</a><a
                                    class="btn btn-border mr-5" href="shop-grid">Dashboard</a><a
                                    class="btn btn-border mr-5" href="shop-grid">Keyboard</a></div>
                        </div>
