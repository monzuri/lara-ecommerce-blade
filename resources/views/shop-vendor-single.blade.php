        ...
        <div class="breadcrumbs-div">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><a class="font-xs color-gray-500" href="blog">Ecom JSC</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="d-flex box-banner-vendor">
                <div class="vendor-left">
                    <div class="banner-vendor"><img src="assets/imgs/page/vendor/featured.png" alt="Ecom">
                        <div class="d-flex box-info-vendor">
                            <div class="avarta"><img class="mb-5" src="assets/imgs/page/vendor/fasfox.png"
                                    alt="Ecom"><a class="btn btn-buy font-xs" href="shop-fullwidth">360 Products</a>
                            </div>
                            <div class="info-vendor">
                                <h4 class="mb-5">Fasfox Coporation</h4><span
                                    class="font-xs color-gray-500 mr-20">Member since
                                    2012</span>
                                ...
                                <div class="row">
                                    <div class="col-xl-7 col-lg-12">
                                        <div class="d-inline-block font-md color-gray-500 location mb-10">5171 W
                                            Campbell Ave undefined
                                            Kent, Utah 53127 United States</div>
                                    </div>
                                    <div class="col-xl-5 col-lg-12">
                                        <div class="d-inline-block font-md color-gray-500 phone">(+91) -
                                            540-025-124553<br>(+91) -
                                            540-025-235688</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="vendor-right">
                    <div class="box-featured-product">
                        <div class="item-featured">
                            <div class="featured-icon"><img src="assets/imgs/page/product/delivery.svg" alt="Ecom">
                            </div>
                        ...
                        <div class="item-featured">
                            <div class="featured-icon"><img src="assets/imgs/page/product/support.svg" alt="Ecom">
                            </div>
                        ...
                        <div class="item-featured">
                            <div class="featured-icon"><img src="assets/imgs/page/product/return.svg" alt="Ecom">
                            </div>
                        ...
                        <div class="item-featured">
                            <div class="featured-icon"><img src="assets/imgs/page/product/payment.svg" alt="Ecom">
                            </div>
                    ...
                    <div class="list-products-5 mt-20">
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        ...
                                        href="shop-single-product-2">Samsung 36&quot; French door 28
                                        cu. ft. Smart Energy Star </a>
                        ...
                        <div class="card-grid-style-3">
                            <div class="card-grid-inner">
                                ...
                                <div class="info-right"><a class="font-xs color-gray-500"
                                        href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                                        href="shop-single-product-2">2022 Apple iMac with Retina 5K
                                        Display 8GB RAM</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                            alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
