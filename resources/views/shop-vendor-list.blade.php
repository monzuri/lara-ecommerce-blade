      ...
      <div class="breadcrumbs-div">
        <div class="container">
          <ul class="breadcrumb">
            ...
            <li><a class="font-xs color-gray-500" href="blog">Vendor listing</a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 mb-30">
            <p class="font-md color-gray-500">We have<span class="font-md-bold color-brand-3"> 780</span><span> vendors
                now</span></p>
          </div>
          <div class="col-lg-6 mb-30 text-end"><a class="font-sm color-gray-900 mr-30" href="#">Support Ticket</a><a
              class="font-sm color-gray-900 mr-30" href="#">Become an Affilate</a><a
              class="btn btn-buy w-auto font-sm-bold" href="page-register">Open a Shop</a></div>
        </div>
            ...
            <div class="box-filters mt-0 pb-5 border-bottom">
              <div class="row">
                ...
                <div class="col-xl-10 col-lg-9 mb-10 text-lg-end text-center"><span
                  ...
                  <div class="d-inline-block"><span class="font-sm color-gray-500 font-medium">Sort by:</span>
                    <div class="dropdown dropdown-sort border-1-right">
                      <button class="btn dropdown-toggle font-sm color-gray-900 font-medium" id="dropdownSort"
                        type="button" data-bs-toggle="dropdown" aria-expanded="false">Latest added</button>
                  ...
                  <div class="d-inline-block"><a class="view-type-grid mr-5 active" href="shop-vendor-list"></a><a
                      class="view-type-list" href="#"></a></div>
                </div>
              </div>
            </div>
            <div class="row mt-20">
              <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="card-vendor">
                  <div class="card-top-vendor">
                    ...
                    <div class="card-top-vendor-right"><a class="btn btn-gray" href="shop-vendor-single">360
                        Products</a>
                      <p class="font-xs color-gray-500 mt-10">Member since 2012</p>
                    </div>
                  </div>
                  <div class="card-bottom-vendor">
                    <p class="font-sm color-gray-500 location mb-10">5171 W Campbell Ave undefined Kent, Utah 53127
                      United States</p>
          ...
          <div class="col-lg-3 order-last order-lg-first">
            <div class="sidebar-border">
              ...
              <div class="sidebar-content">
                <ul class="list-nav-arrow">
                  <li><a href="shop-vendor-list">Computers & Laptop<span class="number">09</span></a></li>
                  <li><a href="shop-vendor-list">Electric accessories<span class="number">12</span></a></li>
                  <li><a href="shop-vendor-list">Fashion & Beauty<span class="number">24</span></a></li>
                  <li><a href="shop-vendor-list">Furniture & Appliances<span class="number">34</span></a></li>
                  <li><a href="shop-vendor-list">Sports and Outdoors<span class="number">65</span></a></li>
                  <li><a href="shop-vendor-list">Food, condiments<span class="number">15</span></a></li>
                  <li><a href="shop-vendor-list">Book, Office supplies<span class="number">76</span></a></li>
                  <li><a href="shop-vendor-list">Children and mothers<span class="number">89</span></a></li>
                  <li><a href="shop-vendor-list">Cars, motorbikes<span class="number">23</span></a></li>
                  <li><a href="shop-vendor-list">Other<span class="number">98</span></a></li>
                </ul>
                <div>
                  <div class="collapse" id="moreMenu">
                    <ul class="list-nav-arrow">
                      <li><a href="shop-vendor-list">Home theater<span class="number">98</span></a></li>
                      <li><a href="shop-vendor-list">Cameras & drones<span class="number">124</span></a></li>
                      <li><a href="shop-vendor-list">PC gaming<span class="number">56</span></a></li>
                      <li><a href="shop-vendor-list">Smart home<span class="number">87</span></a></li>
                      <li><a href="shop-vendor-list">Networking<span class="number">36</span></a></li>
                    </ul>
            ...
            <div class="box-slider-item">
              <div class="head pb-15 border-brand-2">
                <h5 class="color-gray-900">Vendor by tags</h5>
              </div>
              <div class="content-slider mb-50"><a class="btn btn-border mr-5" href="shop-vendor-list">Games</a><a
                  class="btn btn-border mr-5" href="shop-vendor-list">Electronics</a><a class="btn btn-border mr-5"
                  href="shop-vendor-list">Video</a><a class="btn btn-border mr-5"
                  href="shop-vendor-list">Cellphone</a><a class="btn btn-border mr-5"
                  href="shop-vendor-list">Indoor</a><a class="btn btn-border mr-5" href="shop-vendor-list">VGA
                  Card</a><a class="btn btn-border mr-5" href="shop-vendor-list">USB</a><a class="btn btn-border mr-5"
                  href="shop-vendor-list">Lightning</a><a class="btn btn-border mr-5"
                  href="shop-vendor-list">Camera</a><a class="btn btn-border" href="shop-vendor-list">Window</a><a
                  class="btn btn-border mr-5" href="shop-vendor-list">Air Vent</a><a class="btn btn-border mr-5"
                  href="shop-vendor-list">Bedroom</a><a class="btn btn-border mr-5" href="shop-vendor-list">Laptop</a><a
                  class="btn btn-border mr-5" href="shop-vendor-list">Dashboard</a><a class="btn btn-border mr-5"
                  href="shop-vendor-list">Keyboard</a></div>
            </div>
            <div class="box-slider-item">
