            ...
            <div class="card mx-auto card-login">
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="d-flex gap-2 mb-4"><a class="w-50 btn btn-light font-sm" href="{{ url('#') }}">
                                <svg class="icon-svg" aria-hidden="true" style="vertical-align: bottom; margin-top:-4px;"
                                    ...
                                    <path
                                        ...
                                        fill="#EA4335"></path>
                                </svg> Google</a><a class="w-50 btn btn-light font-sm" href="{{ url('#') }}">
                        ...
                        <p class="text-center mb-2">Already have an account?<a
                                href="{{ url('page-account-login.html') }}"> Sign in
                                now</a></p>
                    </form>
                </div>
            </div>
