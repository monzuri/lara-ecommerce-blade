                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="banner-big bg-11"
                                                ...
                                                <div class="mt-30"><a class="btn btn-brand-2" href="shop-grid">Shop
                                                        now</a><a class="btn btn-link" href="shop-grid">Learn more</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-6 col-sm-12">
                                    <div class="banner-small banner-small-1 bg-13"><span
                                        ...
                                        <div class="mt-20"><a class="btn btn-brand-3 btn-arrow-right" href="shop-grid">Shop
                                                now</a></div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-6 col-sm-12">
                                    <div class="banner-small banner-small-2 bg-14"><span
                                        ...
                                        <p class="color-brand-3 font-md">Don&apos;t miss the last<br
                                                class="d-none d-lg-block"> opportunity.</p>
                                        <div class="mt-20"><a class="btn btn-brand-2 btn-arrow-right" href="shop-grid">Shop
                                                now</a></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="list-brands">
                            <div class="box-swiper">
                                <div class="swiper-container swiper-group-7">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide"><a href="shop-grid"><img
                                                    src="assets/imgs/slider/logo/acer.svg" alt="Ecom"></a></div>
                                        <div class="swiper-slide"><a href="shop-grid"><img
                                                    src="assets/imgs/slider/logo/nokia.svg" alt="Ecom"></a></div>
                                        <div class="swiper-slide"><a href="shop-grid"><img
                                                    src="assets/imgs/slider/logo/assus.svg" alt="Ecom"></a></div>
                                        <div class="swiper-slide"><a href="shop-grid"><img
                                                    src="assets/imgs/slider/logo/casio.svg" alt="Ecom"></a></div>
                                        <div class="swiper-slide"><a href="shop-grid"><img
                                                    src="assets/imgs/slider/logo/dell.svg" alt="Ecom"></a></div>
                                        <div class="swiper-slide"><a href="shop-grid"><img
                                                    src="assets/imgs/slider/logo/panasonic.svg" alt="Ecom"></a></div>
                                        <div class="swiper-slide"><a href="shop-grid"><img
                                                    src="assets/imgs/slider/logo/vaio.svg" alt="Ecom"></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card-grid-style-2 card-grid-style-2-small hover-up">
                                <div class="image-box"><a href="shop-grid"><img
                                            src="assets/imgs/page/homepage1/smartphone.png" alt="Ecom"></a></div>
                                <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-grid">
                                        <h6>Smart Phone</h6>
                                    </a>
                                    <ul class="list-links-disc">
                                        <li><a class="font-sm" href="shop-grid">Phone Accessories</a></li>
                                        <li><a class="font-sm" href="shop-grid">Phone Cases</a></li>
                                        <li><a class="font-sm" href="shop-grid">Postpaid Phones</a></li>
                                        <li><a class="font-sm" href="shop-grid">Refurbished Phones</a></li>
                                    </ul><a class="btn btn-gray-abs" href="shop-grid">View all</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card-grid-style-2 card-grid-style-2-small hover-up">
                                <div class="image-box"><a href="shop-grid"><img
                                            src="assets/imgs/page/homepage1/television.png" alt="Ecom"></a></div>
                                <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-grid">
                                        <h6>Television</h6>
                                    </a>
                                    <ul class="list-links-disc">
                                        <li><a class="font-sm" href="shop-grid">HD DVD Players</a></li>
                                        <li><a class="font-sm" href="shop-grid">Projection Screens</a></li>
                                        <li><a class="font-sm" href="shop-grid">Television Accessories</a></li>
                                        <li><a class="font-sm" href="shop-grid">TV-DVD Combos</a></li>
                                    </ul><a class="btn btn-gray-abs" href="shop-grid">View all</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card-grid-style-2 card-grid-style-2-small hover-up">
                                <div class="image-box"><a href="shop-grid"><img
                                            src="assets/imgs/page/homepage1/computer.png" alt="Ecom"></a></div>
                                <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-grid">
                                        <h6>Computers</h6>
                                    </a>
                                    <ul class="list-links-disc">
                                        <li><a class="font-sm" href="shop-grid">Computer Components</a></li>
                                        <li><a class="font-sm" href="shop-grid">Computer Accessories</a></li>
                                        <li><a class="font-sm" href="shop-grid">Desktops</a></li>
                                        <li><a class="font-sm" href="shop-grid">Monitors</a></li>
                                    </ul><a class="btn btn-gray-abs" href="shop-grid">View all</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card-grid-style-2 card-grid-style-2-small hover-up">
                                <div class="image-box"><a href="shop-grid"><img
                                            src="assets/imgs/page/homepage1/electric.png" alt="Ecom"></a></div>
                                <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-grid">
                                        <h6>Electronics</h6>
                                    </a>
                                    <ul class="list-links-disc">
                                        <li><a class="font-sm" href="shop-grid">Office Electronics</a></li>
                                        <li><a class="font-sm" href="shop-grid">Portable Audio &amp; Video</a></li>
                                        <li><a class="font-sm" href="shop-grid">Washing Machine</a></li>
                                        <li><a class="font-sm" href="shop-grid">Accessories &amp; Supplies</a></li>
                                    </ul><a class="btn btn-gray-abs" href="shop-grid">View all</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card-grid-style-2 card-grid-style-2-small hover-up">
                                <div class="image-box"><a href="shop-grid"><img
                                            src="assets/imgs/page/homepage1/laptop.png" alt="Ecom"></a></div>
                                <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-grid">
                                        <h6>Laptop &amp; Tablet</h6>
                                    </a>
                                    <ul class="list-links-disc">
                                        <li><a class="font-sm" href="shop-grid">Office laptop</a></li>
                                        <li><a class="font-sm" href="shop-grid">Gaming laptop</a></li>
                                        <li><a class="font-sm" href="shop-grid">Laptop accessories</a></li>
                                        <li><a class="font-sm" href="shop-grid">Tablet</a></li>
                                    </ul><a class="btn btn-gray-abs" href="shop-grid">View all</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card-grid-style-2 card-grid-style-2-small hover-up">
                                <div class="image-box"><a href="shop-grid"><img
                                            src="assets/imgs/page/homepage1/smartwatches.png" alt="Ecom"></a></div>
                                <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-grid">
                                        <h6>Smartwatches</h6>
                                    </a>
                                    <ul class="list-links-disc">
                                        <li><a class="font-sm" href="shop-grid">Sport Watches</a></li>
                                        <li><a class="font-sm" href="shop-grid">Chronograph Watches</a></li>
                                        <li><a class="font-sm" href="shop-grid">Kids Watches</a></li>
                                        <li><a class="font-sm" href="shop-grid">Luxury Watches</a></li>
                                    </ul><a class="btn btn-gray-abs" href="shop-grid">View all</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card-grid-style-2 card-grid-style-2-small hover-up">
                                <div class="image-box"><a href="shop-grid"><img
                                            src="assets/imgs/page/homepage1/gaming.png" alt="Ecom"></a></div>
                                <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-grid">
                                        <h6>Gaming</h6>
                                    </a>
                                    <ul class="list-links-disc">
                                        <li><a class="font-sm" href="shop-grid">Game Controllers</a></li>
                                        <li><a class="font-sm" href="shop-grid">Gaming Keyboards</a></li>
                                        <li><a class="font-sm" href="shop-grid">PC Gaming Mice</a></li>
                                        <li><a class="font-sm" href="shop-grid">PC Game Headsets</a></li>
                                    </ul><a class="btn btn-gray-abs" href="shop-grid">View all</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card-grid-style-2 card-grid-style-2-small hover-up">
                                <div class="image-box"><a href="shop-grid"><img
                                            src="assets/imgs/page/homepage1/outdoor.png" alt="Ecom"></a></div>
                                <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-grid">
                                        <h6>Outdoor Camera</h6>
                                    </a>
                                    <ul class="list-links-disc">
                                        <li><a class="font-sm" href="shop-grid">Security &amp; Surveillance</a></li>
                                        <li><a class="font-sm" href="shop-grid">Surveillance DVR Kits</a></li>
                                        <li><a class="font-sm" href="shop-grid">Surveillance NVR Kits</a></li>
                                        <li><a class="font-sm" href="shop-grid">Smart Outdoor Lighting</a></li>
                                    </ul><a class="btn btn-gray-abs" href="shop-grid">View all</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-7 col-md-7 col-sm-12 mb-30">
                        <div class="bg-4 block-samsung"><span class="color-brand-3 font-sm-lh32">New Arrivals</span>
                            ...
                            <p class="font-base color-brand-3 mb-20">Special Sale</p><a
                                class="btn btn-brand-2 btn-arrow-right" href="shop-grid">learn more</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <ul class="nav nav-tabs" role="tablist">
                                <li><a class="active" href="#tab-all" data-bs-toggle="tab" role="tab"
                                        aria-controls="tab-all" aria-selected="true">All</a></li>
                                <li><a href="#tab-bestseller" data-bs-toggle="tab" role="tab"
                                        aria-controls="tab-bestseller" aria-selected="true">Best seller</a></li>
                                <li><a href="#tab-mostviewed" data-bs-toggle="tab" role="tab"
                                        aria-controls="tab-mostviewed" aria-selected="true">Most viewed</a></li>
                                <li><a href="#tab-topbrands" data-bs-toggle="tab" role="tab"
                        ...
                        <div class="list-products-5">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#"
                                            ...
                                            href="shop-compare" aria-label="Compare"></a><a
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            ...
                                            href="shop-single-product">2022 Apple
                                        ...
                                        <div class="mt-20 box-btn-cart"><a class="btn btn-cart" href="shop-cart">Add
                                                To Cart</a></div>
                                ...
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                            href="shop-single-product"><img src="assets/imgs/page/homepage1/imgsp4.png"
                                                alt="Ecom"></a></div>
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single">Philips</a><br><a class="color-brand-3 font-sm-bold"
                                            href="shop-single-product">Philips
                            ...
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                                            href="shop-single-product">2020 Apple
                            ...
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                                            href="shop-single-product">Apple Watch
                                ...
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                            href="shop-single-product"><img src="assets/imgs/page/homepage1/imgsp7.png"
                                                alt="Ecom"></a></div>
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single">Kami Tech</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product">Kami by YI
                        ...
                        <div class="list-products-5">
                            ...
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single">Kami Tech</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product">Kami by
                        ...
                        <div class="list-products-5">
                                ...
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                            href="shop-single-product"><img src="assets/imgs/page/homepage1/imgsp1.png"
                                                alt="Ecom"></a></div>
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single">Philips</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product">Philips
                                            H4205 On-Ear Wireless Headphones with 32mm</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Ecom"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                                            href="shop-single-product">Apple
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-end">
                            <div class="box-all-hurry">
                                ...
                                </div><a class="btn btn-view-all font-md-bold" href="shop-single-product">View
                                    All</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card-grid-style-3 hover-show hurry-up">
                            <div class="card-grid-inner">
                                <div class="tools"><a class="btn btn-trend mb-10" href="shop-single-product"></a><a
                                        class="btn btn-wishlist mb-10" href="shop-single-product"></a><a
                                        class="btn btn-compare mb-10" href="shop-single-product"></a><a
                                        class="btn btn-quickview" aria-label="Quick view" href="#ModalQuickview"
                                        ...
                                        <div class="swiper-container swiper-group-1">
                                            <div class="swiper-wrapper pt-5">
                                                <div class="swiper-slide"><img
                                                        src="assets/imgs/page/homepage1/screen.png" alt="Ecom">
                                                </div>
                                                <div class="swiper-slide"><img
                                                        src="assets/imgs/page/homepage1/screen-2.png" alt="Ecom">
                                                </div>
                                                <div class="swiper-slide"><img
                                                        src="assets/imgs/page/homepage1/screen-3.png" alt="Ecom">
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                                href="shop-single-product"><img
                                                    src="assets/imgs/page/homepage1/imgsp1.png" alt="Ecom"></a>
                                        </div>
                                        <div class="info-right"><span
                                                class="font-xs color-gray-500">Samsung</span><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Samsung
                                            ...
                                            <div class="price-info"><strong
                                                    class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span
                                                    class="color-gray-500 price-line">$3225.6</span></div>
                                            <div class="mt-20"><a class="btn btn-cart" href="shop-cart">Add To
                                                    Cart</a></div>
                                            <ul class="list-features">
                                                <li> 27-inch (diagonal) Retina 5K display</li>
                                            </ul>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                                href="shop-single-product"><img
                                                    src="assets/imgs/page/homepage1/imgsp2.png" alt="Ecom"></a>
                                        </div>
                                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Lenovo
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Apple
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Razer
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">ASUS
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product">Fujifilm
                ...
                <div class="list-products-5">
                    <div class="card-grid-style-3">
                        <div class="card-grid-inner">
                            ...
                            <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                    class="color-brand-3 font-sm-bold" href="shop-single-product">Klipsch ProMedia
                                ...
                                <div class="price-info"><strong
                                        class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span
                                        class="color-gray-500 price-line">$3225.6</span></div>
                                <div class="mt-20"><a class="btn btn-cart" href="shop-cart">Add To Cart</a>
                                </div>
                                <ul class="list-features">
                                    <li> 27-inch (diagonal) Retina 5K display</li>
                                </ul>
                    ...
                    <div class="card-grid-style-3">
                        <div class="card-grid-inner">
                            ...
                            <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                    class="color-brand-3 font-sm-bold" href="shop-single-product">Apple TV HD 32GB
                    ...
                    <div class="card-grid-style-3">
                        <div class="card-grid-inner">
                            ...
                            <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                    class="color-brand-3 font-sm-bold" href="shop-single-product">Hisense 40&quot;
                    ...
                    <div class="card-grid-style-3">
                        <div class="card-grid-inner">
                            ...
                            <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                    class="color-brand-3 font-sm-bold" href="shop-single-product">2022 Apple
                    ...
                    <div class="card-grid-style-3">
                        <div class="card-grid-inner">
                            ...
                            <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                    class="color-brand-3 font-sm-bold" href="shop-single-product">LeapFrog LeapPad
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-12">
                        <div class="banner-2 bg-xbox"><span class="color-danger text-uppercase">Flat 20% off</span>
                            ...
                            <div class="mt-25"><a class="btn btn-brand-2 btn-arrow-right" href="shop-fullwidth">Shop
                                    Now</a></div>
                        </div>
                    </div>
                            ...
                            <div class="image-big">
                                <div class="banner-img-left bg-controller">
                                    ...
                                    <div class="mt-25"><a class="btn btn-info btn-arrow-right"
                                            href="shop-fullwidth">Shop Now</a></div>
                                </div>
                            </div>
                            <div class="image-small">
                                <div class="bg-metaverse">
                                    ...
                                    <div class="mt-15"><a class="btn btn-link-brand-2 btn-arrow-brand-2"
                                            href="shop-fullwidth">learn more</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="image-gallery">
            ...
            <div class="container">
                <div class="head-main bd-gray-200">
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <ul class="nav nav-tabs" role="tablist">
                                <li><a class="active" href="#tab-2-all" data-bs-toggle="tab" role="tab"
                                        aria-controls="tab-2-all" aria-selected="true">All</a></li>
                                <li><a href="#tab-2-bestseller" data-bs-toggle="tab" role="tab"
                                        aria-controls="tab-2-bestseller" aria-selected="true">Best seller</a></li>
                                <li><a href="#tab-2-mostviewed" data-bs-toggle="tab" role="tab"
                                        aria-controls="tab-2-mostviewed" aria-selected="true">Most viewed</a></li>
                                <li><a href="#tab-2-topbrands" data-bs-toggle="tab" role="tab"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-grid-style-2">
                                                    ...
                                                    <div class="info-right"><span
                                                            ...
                                                            href="shop-single-product-2">2022 Apple iMac with Retina
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-grid-style-2">
                                                    ...
                                                    <div class="info-right"><span
                                                            ...
                                                            class="color-brand-3 font-sm-bold"
                                                            href="shop-single-product-2">Philips H4205 On-Ear
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-grid-style-2">
                                                    ...
                                                    <div class="info-right"><span
                                                            class="font-xs color-gray-500">Apple</span><br><a
                                                            class="color-brand-3 font-sm-bold"
                                                            href="shop-single-product-2">2020 Apple MacBook Air
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-grid-style-2">
                                                    ...
                                                    <div class="info-right"><span
                                                            class="font-xs color-gray-500">Apple</span><br><a
                                                            class="color-brand-3 font-sm-bold"
                                                            href="shop-single-product-2">Apple Watch Series 8 [GPS
                                                            45mm] Smart Watch</a>
                                                        <div class="rating"><img
                                                                src="assets/imgs/template/icons/star.svg"
                                                                alt="Ecom"><img
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-grid-style-2">
                                                    ...
                                                    <div class="info-right"><span class="font-xs color-gray-500">Kami
                                                            ...
                                                            href="shop-single-product-2">Kami by YI 4pc 1080p Home
                                                            Security Cameras</a>
                                                        <div class="rating"><img
                                                                src="assets/imgs/template/icons/star.svg"
                                                                alt="Ecom"><img
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-style-1">
                                    <div class="image-box"><a href="blog-single-2"></a><img
                                            src="assets/imgs/page/blog/blog-1.jpg" alt="Ecom"></div><a
                                        class="tag-dot font-xs" href="blog-list">Technology</a><a
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-style-1">
                                    <div class="image-box"><a href="blog-single"></a><img
                                            src="assets/imgs/page/blog/blog-2.jpg" alt="Ecom"></div><a
                                        class="tag-dot font-xs" href="blog-list">Technology</a><a
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-style-1">
                                    <div class="image-box"><a href="blog-single-3"></a><img
                                        ...
                                        class="tag-dot font-xs" href="blog-list">Gaming</a><a class="color-gray-1100"
                                        href="blog-single-3">
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-style-1">
                                    <div class="image-box"><a href="blog-single-2"></a><img
                                        ...
                                        class="tag-dot font-xs" href="blog-list">Blockchain</a><a
                                        class="color-gray-1100" href="blog-single-2">
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-style-1">
                                    <div class="image-box"><a href="blog-single-2"></a><img
                                        ...
                                        class="tag-dot font-xs" href="blog-list">Development</a><a
                                        class="color-gray-1100" href="blog-single-2">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="buy-product mt-5">
                                        ...
                                        <div class="box-quantity">
                                            ...
                                            <div class="button-buy"><a class="btn btn-cart" href="shop-cart">Add
                                                    to cart</a><a class="btn btn-buy" href="shop-checkout">Buy
                                                    now</a></div>
                                        </div>
                                    </div>
                                </div>
