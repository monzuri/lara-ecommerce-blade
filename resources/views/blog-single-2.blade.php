                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-50 display-list"><a class="tag-dot font-xs"
                                ...
                                <div class="box-author mb-5">
                                    <div class="img-author mr-30"><img src="assets/imgs/page/blog/author.png"
                                ...
                                <div class="image-feature"><img src="assets/imgs/page/blog/img-big.png" alt="Ecom">
                                </div>
                                <div class="content-text">
                                    <p>Nibiru, a new crypto derivatives protocol co-founded by Tribe Capital GP Arjun
                                        Sethi, has raised $7.5 million in seed funding at a valuation of $100 million,
                                        two sources familiar with the matter told TechCrunch.<br>Tribe Capital, Republic
                                        Crypto and Kraken invested in the seed round, a source said, requesting
                                        anonymity as the information is not public.<br>Sethi co-founded the startups
                                        with four industry veterans — including Sankha Banerjee, formerly with Credence
                                        Capital and Binance; and Boris Revsin, who co-founded Republic Capital. Nibiru
                                        has attracted nearly two dozen contributors from firms including Meta, Reddit,
                                        JP Morgan and Yahoo, an investor deck obtained by TechCrunch showed.</p>
                                    <p>The crypto market is flooded with centralized (Binance, FTX) and decentralized
                                        ETH-based perpetuals and options trading platforms (Dydx, Opyn, Perpetual
                                        Protocol). Nibiru is attempting to build the first mainstream decentralized
                                        multichain solution, according to its website.<br>Currently in private testnet,
                                        Nibiru’s decentralized protocol unifies derivatives trading, spot trading,
                                        staking and bonded liquidity, and aims to serve users across over 40
                                        blockchains, it says on the website.<br>On its investor deck, Nibiru says it
                                        will provide customers with unlocked hedging opportunities, extremely low gas
                                        costs, MEV resistance and high futures volume. It is also creating composable
                                        yield in rising/falling regimes using decentralized perps and options, the deck
                                        added.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                        quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                                        consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                                        dolore eu fugiat nulla pariatur. Nibiru, a new crypto derivatives protocol
                                        co-founded by Tribe Capital GP Arjun Sethi, has raised $7.5 million in seed
                                        funding at a valuation of $100 million, two sources familiar with the matter
                                        told TechCrunch. has raised $7.5 million in seed funding at a valuation of $100
                                        million, two sources familiar with the matter told TechCrunch.</p>
                                    ...
                                    <p>Nibiru, a new crypto derivatives protocol co-founded by Tribe Capital GP Arjun
                                        ...
                                        has attracted nearly two dozen contributors from firms including Meta, Reddit,
                                        JP Morgan and Yahoo, an investor deck obtained by TechCrunch showed.</p>
                                    <div class="image-single"><img src="assets/imgs/page/blog/img-single.png"
                                            alt="Ecom"></div>
                                    <p>Nibiru, a new crypto derivatives protocol co-founded by Tribe Capital GP Arjun
                                        Sethi, has raised $7.5 million in seed funding at a valuation of $100 million,
                                        two sources familiar with the matter told TechCrunch.<br>Tribe Capital, Republic
                                ...
                                <div class="comment-box">
                                    <div class="comment-item">
                                        <div class="top-comment">
                                            <div class="image-author"> <img src="assets/imgs/page/blog/author.png"
                                                    alt="Ecom"></div>
                                            <div class="author-name"> <span class="font-md-bold color-gray-900">Sugar
                                                ...
                                                <div class="info-author"><span class="font-sm color-gray-500">306
                                                        posts</span><span class="font-sm color-gray-500">Since
                                                        2012</span></div>
                                            </div>
                                        </div>
                                ...
                                <div class="comment-box mb-60">
                                    <div class="comment-item comment-item-small">
                                        ...
                                        <div class="comment-content font-md">
                                            ...
                                            eu fugiat nulla pariatur. Nibiru, a new crypto derivatives protocol
                                            co-founded by Tribe Capital GP Arjun Sethi, has raised $7.5 million in seed
                                            funding at a valuation of $100 million, two sources familiar with the matter
                                            told TechCrunch.</div>
                                    </div>
                                ...
                                <div class="nav-center text-end">
                                    <nav>
                                        <ul class="pagination">
                                            <li class="page-item"><a class="page-link page-prev" href="#"></a>
                                            </li>
                                            ...
                                            <li class="page-item"><a class="page-link page-next" href="#"></a>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
                                        ...
                                        <div class="swiper-wrapper pt-5">
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="card-grid-style-2 card-none-border mb-30 pb-5 mh-auto">
                                                    ...
                                                    <div class="info-right"><a class="color-brand-3 font-sm"
                                                            href="blog-single">Take no prisoners: In the Feds inflation
                                                            fight</a>
                                                        <div class="row mt-5">
                                                            <div class="col-12"><span
                                                                    class="color-gray-500 font-xs mr-20">August 30,
                ...
                <div class="row mt-30">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-40">
                        <div class="card-grid-style-1">
                            <div class="image-box"><a href="blog-single"><img src="assets/imgs/page/blog/blog-17.jpg"
                                        alt="Ecom"></a></div><a class="tag-dot font-xs"
                                href="#">Technology</a><a class="color-gray-1100" href="blog-single">
                                <h4 class="mb-10">Amazon’s ‘Safe’ New Robot Won’t Fix its Worker</h4>
                            </a>
                            <div class="row mt-20">
                                <div class="col-12"><span class="color-gray-500 font-xs mr-30">August 30,
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-40">
                        <div class="card-grid-style-1">
                            <div class="image-box"><a href="blog-single"><img src="assets/imgs/page/blog/blog-16.jpg"
                                        alt="Ecom"></a></div><a class="tag-dot font-xs"
                                href="#">Technology</a><a class="color-gray-1100" href="blog-single">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-40">
                        <div class="card-grid-style-1">
                            <div class="image-box"><a href="blog-single"><img src="assets/imgs/page/blog/blog-15.jpg"
                                        alt="Ecom"></a></div><a class="tag-dot font-xs"
                                href="#">Technology</a><a class="color-gray-1100" href="blog-single">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-40">
                        <div class="card-grid-style-1">
                            <div class="image-box"><a href="blog-single"><img src="assets/imgs/page/blog/blog-7.jpg"
                                        alt="Ecom"></a></div><a class="tag-dot font-xs"
                                href="#">Technology</a><a class="color-gray-1100" href="blog-single">
        ...
        <section class="section-box mt-90 mb-50">
            <div class="container">
                <ul class="list-col-5">
                    <li>
                        <div class="item-list">
                            <div class="icon-left"><img src="assets/imgs/template/delivery.svg" alt="Ecom">
                            </div>
                    ...
                    <li>
                        <div class="item-list">
                            <div class="icon-left"><img src="assets/imgs/template/support.svg" alt="Ecom">
                            </div>
                            <div class="info-right">
                    ...
                    <li>
                        <div class="item-list">
                            <div class="icon-left"><img src="assets/imgs/template/voucher.svg" alt="Ecom">
                            </div>
                            <div class="info-right">
                    ...
                    <li>
                        <div class="item-list">
                            <div class="icon-left"><img src="assets/imgs/template/return.svg" alt="Ecom">
                            </div>
                            <div class="info-right">
                    ...
                    <li>
                        <div class="item-list">
                            <div class="icon-left"><img src="assets/imgs/template/secure.svg" alt="Ecom">
                            </div>
                            <div class="info-right">
