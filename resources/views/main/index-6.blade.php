        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="banner-left">
              <div class="box-adsolute-banner">
                <h5 class="color-gray-900">Office Collection</h5><a class="btn btn-link-brand-2 text-capitalize">Shop
                  Now</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="banner-right-home6">
              <div class="box-adsolute-banner">
                <h5 class="color-gray-900">Comfort Chair</h5><a class="btn btn-link-brand-2 text-capitalize">Shop
                  Now</a>
              </div>
            </div>
          </div>
              ...
              <div class="swiper-wrapper pt-5">
                <div class="swiper-slide">
                  <div class="card-category">
                    <div class="card-image"><a href="#"><img src="assets/imgs/page/homepage6/living-room.png"
                          alt="Ecom"></a></div>
                    <div class="card-info"><a href="blog-single">
                        <h5 class="color-brand-3 mb-5">Living Room</h5>
                        <p class="font-md color-gray-500">156 products</p>
                      </a></div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="card-category">
                    <div class="card-image"><a href="#"><img src="assets/imgs/page/homepage6/reading-room.png"
                          alt="Ecom"></a></div>
                    <div class="card-info"><a href="blog-single">
                ...
                <div class="swiper-slide">
                  <div class="card-category">
                    <div class="card-image"><a href="#"><img src="assets/imgs/page/homepage6/bed-room.png"
                          alt="Ecom"></a></div>
                    <div class="card-info"><a href="blog-single">
                ...
                <div class="swiper-slide">
                  <div class="card-category">
                    <div class="card-image"><a href="#"><img src="assets/imgs/page/homepage6/kitchen.png"
                          alt="Ecom"></a></div>
                    <div class="card-info"><a href="blog-single">
                ...
                <div class="swiper-slide">
                  <div class="card-category">
                    <div class="card-image"><a href="#"><img src="assets/imgs/page/homepage6/decoration.png"
                          alt="Ecom"></a></div>
                    <div class="card-info"><a href="blog-single">
        ...
        <div class="head-main bd-gray-200">
          <div class="row">
            <div class="col-xl-6 col-lg-6">
              ...
              <p class="font-base color-gray-500">Shop living room furniture, crafted by designers all over the world
              </p>
            </div>
            <div class="col-xl-6 col-lg-6">
                      ...
                      <div class="card-grid-style-3 home6-style">
                        <div class="card-grid-inner">
                          ...
                          <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                              href="shop-single-product-2"><img src="assets/imgs/page/homepage6/sp1.png" alt="Ecom"></a>
                          </div>
                      ...
                      <div class="card-grid-style-3 home6-style">
                        <div class="card-grid-inner">
                          ...
                          <div class="image-box"><span class="label bg-danger">Hot</span><a
                              href="shop-single-product-2"><img src="assets/imgs/page/homepage6/sp2.png" alt="Ecom"></a>
                          </div>
                          <div class="info-right"><a class="font-xs color-gray-500"
                              href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                      ...
                      <div class="card-grid-style-3 home6-style">
                        <div class="card-grid-inner">
                          ...
                          <div class="image-box"><span class="label bg-success">New</span><a
                              href="shop-single-product-2"><img src="assets/imgs/page/homepage6/sp3.png" alt="Ecom"></a>
                          </div>
                          <div class="info-right"><a class="font-xs color-gray-500"
                              href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                      ...
                      <div class="card-grid-style-3 home6-style">
                        <div class="card-grid-inner">
                          ...
                          <div class="image-box"><a href="shop-single-product-2"><img
                                src="assets/imgs/page/homepage6/sp4.png" alt="Ecom"></a>
                          </div>
                          <div class="info-right"><a class="font-xs color-gray-500"
                              href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                      ...
                      <div class="card-grid-style-3 home6-style">
                        <div class="card-grid-inner">
                          <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                              ...
                              data-bs-toggle="modal"></a></div>
                          <div class="image-box"><a href="shop-single-product-2"><img
                                src="assets/imgs/page/homepage6/sp5.png" alt="Ecom"></a>
                          </div>
                          <div class="info-right"><a class="font-xs color-gray-500"
                              href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                              href="shop-single-product-2">MSI Optix G272 27&quot; Full HD LED Gaming LCD Monitor</a>
                      ...
                      <div class="card-grid-style-3 home6-style">
                        <div class="card-grid-inner">
                          <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                              ...
                              data-bs-toggle="modal"></a></div>
                          <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                              href="shop-single-product-2"><img src="assets/imgs/page/homepage6/sp6.png" alt="Ecom"></a>
                          </div>
                          <div class="info-right"><a class="font-xs color-gray-500"
                              href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                              href="shop-single-product-2">HP 11.6&quot; Chromebook, AMD A4, 4GB RAM, 32GB Storage</a>
                      ...
                      <div class="card-grid-style-3 home6-style">
                        <div class="card-grid-inner">
                          <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                              ...
                              data-bs-toggle="modal"></a></div>
                          <div class="image-box"><span class="label bg-danger">Hot</span><a
                              href="shop-single-product-2"><img src="assets/imgs/page/homepage6/sp7.png" alt="Ecom"></a>
                          </div>
                          <div class="info-right"><a class="font-xs color-gray-500"
                              href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                              href="shop-single-product-2">ASUS VivoBook 15.6&quot; 1080p PC Laptops, Intel Core i3</a>
                      ...
                      <div class="card-grid-style-3 home6-style">
                        <div class="card-grid-inner">
                          <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                              ...
                              data-bs-toggle="modal"></a></div>
                          <div class="image-box"><span class="label bg-success">New</span><a
                              href="shop-single-product-2"><img src="assets/imgs/page/homepage6/sp8.png" alt="Ecom"></a>
                          </div>
                          <div class="info-right"><a class="font-xs color-gray-500"
                              href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                              href="shop-single-product-2">2020 Apple 10.9-inch iPad Air Wi-Fi 64GB - Silver</a>
                      ...
                      <div class="card-grid-style-3 home6-style">
                        <div class="card-grid-inner">
                          <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                              ...
                              data-bs-toggle="modal"></a></div>
                          <div class="image-box"><a href="shop-single-product-2"><img
                                src="assets/imgs/page/homepage6/sp9.png" alt="Ecom"></a>
                          </div>
                          <div class="info-right"><a class="font-xs color-gray-500"
                              href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                              href="shop-single-product-2">MSI Optix G272 27&quot; Full HD LED Gaming LCD Monitor</a>
                      ...
                      <div class="card-grid-style-3 home6-style">
                        <div class="card-grid-inner">
                          <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                              ...
                              data-bs-toggle="modal"></a></div>
                          <div class="image-box"><a href="shop-single-product-2"><img
                                src="assets/imgs/page/homepage6/sp10.png" alt="Ecom"></a>
                          </div>
                          <div class="info-right"><a class="font-xs color-gray-500"
                              href="shop-vendor-single">Apple</a><br><a class="color-brand-3 font-sm-bold"
                              href="shop-single-product-2">MSI Optix G272 27&quot; Full HD LED Gaming LCD Monitor</a>
        ...
        <div class="row">
          <div class="col-lg-6 mb-30">
            <div class="card-banner hover-up">
              <div class="card-image"><a href="#"> <img src="assets/imgs/page/homepage6/banner-bottom-1.png"
                    alt="Ecom"></a></div>
              <div class="card-info mt-10 text-center"> <a href="#">
                  <h4 class="color-gray-900">Kitchen sets from $9.99</h4>
                </a>
          ...
          <div class="col-lg-6 mb-30">
            <div class="card-banner hover-up">
              <div class="card-image"> <a href="#"><img src="assets/imgs/page/homepage6/banner-bottom-2.png"
                    alt="Ecom"></a></div>
              <div class="card-info mt-10 text-center"> <a href="#">
                  <h4 class="color-gray-900">Livingroom sets from $9.99</h4>
                </a>
                <p class="font-md color-gray-900">Upto 30% offer</p>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="banner-bottom-3">
              <div class="banner-bottom-info top-style-2">
                ...
                <p class="font-base-2 color-white mb-20">Under $120</p><a class="btn btn-info btn-arrow-right">Shop
                  Now</a>
              </div>
            </div>
          </div>
            ...
            <div class="swiper-wrapper pt-5">
              <div class="swiper-slide">
                <div class="card-grid-style-1">
                  <div class="image-box"><a href="blog-single-2"></a><img src="assets/imgs/page/homepage6/news1.png"
                      alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list">News</a><a class="color-gray-1100"
                    href="blog-single-2">
                    <h4>Smart home that makes you feel like living in resort</h4>
                  </a>
              ...
              <div class="swiper-slide">
                <div class="card-grid-style-1">
                  <div class="image-box"><a href="blog-single"></a><img src="assets/imgs/page/homepage6/news2.png"
                      alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list">News</a><a class="color-gray-1100"
                    href="blog-single">
                    <h4>New chair styles make your room interesting</h4>
                  </a>
                  <div class="mt-20"><span class="color-gray-500 font-xs mr-30">August 30, 2022</span><span
              ...
              <div class="swiper-slide">
                <div class="card-grid-style-1">
                  <div class="image-box"><a href="blog-single-3"></a><img src="assets/imgs/page/homepage6/news3.png"
                      alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list">News</a><a class="color-gray-1100"
                    href="blog-single-3">
                    <h4>Kitchen furniture you need to get a cozy house</h4>
                  </a>
                  <div class="mt-20"><span class="color-gray-500 font-xs mr-30">August 30, 2022</span><span
              ...
              <div class="swiper-slide">
                <div class="card-grid-style-1">
                  <div class="image-box"><a href="blog-single-2"></a><img src="assets/imgs/page/homepage6/news4.png"
                      alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list">Tips</a><a class="color-gray-1100"
                    href="blog-single-2">
                    <h4>How to decore your living room that interesting</h4>
                  </a>
                  <div class="mt-20"><span class="color-gray-500 font-xs mr-30">August 30, 2022</span><span
